...
getCurrentStyleSettings:function(c,b){_.isUndefined(b)&&(b=jQuery(c.currentTarget).data("model_id"),b=tdcIFrameData.getModel(b),c={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,c));var d=b.get("tag");b=b.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){var a={};c={};for(var e in b)0===e.indexOf("tds_")&&(a[e]=b[e]);e=window.tdcAdminSettings.mappedShortcodes[d].params;for(d=0;d<e.length;d++){var h=!1,g=e[d];if(0===g.param_name.indexOf("tds_")){for(var m in a)if(g.param_name===m){c[m]=a[m];
h=!0;break}h||(c[g.param_name]="")}}for(m in a)switch(a=m.split("-"),a.length){case 2:if(!_.has(c,m)){e=a[0];a=!1;for(var n in c)if(e===c[n]&&1===n.split("-").length){a=!0;break}if(!a){var k;for(k in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[k],e)){var l=k;break}_.has(c,l)&&""===c[l]&&window.tdcAdminSettings.globalStyle[l]===e&&(a=!0)}a||delete b[m]}break;case 3:e=a[0];d=a[2];for(k in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[k],
e)){l=k;break}a=!1;for(n in c)if(e===c[n]&&n===l+"-"+d){a=!0;break}a||_.has(c,l+"-"+d)&&""===c[l+"-"+d]&&window.tdcAdminSettings.globalStyle[l]===e&&(a=!0);a||delete b[m]}return b}},getCurrentListAtts:function(c,b,d){_.isUndefined(b)&&(c=jQuery(c.currentTarget).data("model_id"),b=tdcIFrameData.getModel(c),c={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,c));c=b.get("tag");b=b.get("attrs");var a=_.clone(b);if(!_.isUndefined(a)){var e={};b={};for(var h in a)0===h.indexOf("tds_")&&(e[h]=
a[h]);h=window.tdcAdminSettings.mappedShortcodes[c].params;for(var g=0;g<h.length;g++){var m=!1,n=h[g];if(0===n.param_name.indexOf("tds_")){for(var k in e)if(n.param_name===k){b[k]=e[k];m=!0;break}m||(b[n.param_name]="")}}for(k in e)switch(e=k.split("-"),e.length){case 2:if(!_.has(b,k)){h=e[0];e=!1;for(var l in b)if(h===b[l]&&1===l.split("-").length){e=!0;break}if(!e){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){var q=p;break}_.has(b,q)&&
""===b[q]&&window.tdcAdminSettings.globalStyle[q]===h&&(e=!0)}e||delete a[k]}break;case 3:h=e[0];m=e[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){q=p;break}e=!1;for(l in b)if(h===b[l]&&l===q+"-"+m){e=!0;break}e||_.has(b,q+"-"+m)&&""===b[q+"-"+m]&&window.tdcAdminSettings.globalStyle[q]===h&&(e=!0);e||delete a[k]}var r=[],u;for(u in window.tdcAdminSettings.listStyles[d])if(u===c){for(g=0;g<window.tdcAdminSettings.listStyles[d][u].length;g++)k=
window.tdcAdminSettings.listStyles[d][u][g],_.isArray(k)?_.map(k,function(b){_.isUndefined(a[b])||(_.isUndefined(r[g])&&(r[g]=[]),r[g].push(a[b]))}):_.isUndefined(a[k])||(_.isArray(a[k])&&a[k].length?r[g]=a[k][0]:r[g]=a[k]);break}return r}},showHideTdcCssEditor:function(c){c=jQuery("#tdc-editor-css");var b=jQuery(this).closest(".tdc-property-wrap"),d=b.find("textarea:first");c.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=d;b.next(".tdc-property-editor_css-title").length?(b.next(".tdc-property-editor_css-title").toggle(),
c.toggle()):(b.after(c),b.after('<div class="tdc-property-editor_expand tdc-property-editor_css-title"><span></span><div class="tdc-editor-toggle tdc-css-ace-editor-expand-collapse"></div></div>'),c.show(),tdcSidebar.editorCss.getSession().setValue(d.val()))},toggleEnableParamsFromText:function(c){var b=c.closest(".tdc-property-wrap"),d=b.data("enable-params");b=b.data("enable-params-reverse");d=jQuery('.tdc-property-wrap[data-enabled-by="'+d+'"]');d.length&&(""!==c.val()?"undefined"!==typeof b&&
1===b?d.hasClass("tdc-disabled")||d.addClass("tdc-disabled"):d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):"undefined"!==typeof b&&1===b?d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):d.hasClass("tdc-disabled")||d.addClass("tdc-disabled"))},toggleEnableParamsFromSelect:function(c){var b=c.val();c=c.closest(".tdc-property-wrap");var d=c.data("enable-params"),a=c.data("enable-params-reverse"),e=jQuery('.tdc-property-wrap[data-enabled-by^="'+d+'"]');e.length&&e.each(function(c,
d){c=jQuery(d);d=c.data("enabled-by");-1!==d.indexOf("--")?d.substring(d.indexOf("--")+2)===b?"undefined"!==typeof a&&1===a?c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"):c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):"undefined"!==typeof a&&1===a?c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"):""!==b?"undefined"!==typeof a&&1===a?e.hasClass("tdc-disabled")||e.addClass("tdc-disabled"):e.hasClass("tdc-disabled")&&e.removeClass("tdc-disabled"):
"undefined"!==typeof a&&1===a?e.hasClass("tdc-disabled")&&e.removeClass("tdc-disabled"):e.hasClass("tdc-disabled")||e.addClass("tdc-disabled")})},toggleDisableParamsFromSelect:function(c){var b=c.val();c=c.closest(".tdc-property-wrap").data("disable-params");c=jQuery('.tdc-property-wrap[data-disabled-by^="'+c+'"]');c.length&&c.each(function(c,a){c=jQuery(a);a=c.data("disabled-by");-1!==a.indexOf("--")&&(a.substring(a.indexOf("--")+2)===b?c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"):c.hasClass("tdc-disabled")&&
c.removeClass("tdc-disabled"))})},toggleEnableParamsFromCheckbox:function(c){var b=c.closest(".tdc-property-wrap"),d=b.data("enable-params");b=b.data("enable-params-reverse");d=jQuery('.tdc-property-wrap[data-enabled-by="'+d+'"]');d.length&&(c.is(":checked")?"undefined"!==typeof b&&1===b?d.hasClass("tdc-disabled")||d.addClass("tdc-disabled"):d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):"undefined"!==typeof b&&1===b?d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):d.hasClass("tdc-disabled")||
d.addClass("tdc-disabled"))},showHideTdcPalette:function(c){c=jQuery("#tdc-palette");var b=jQuery(this).closest(".tdc-property-wrap");c.length||tdcSidebar.buildPalette();b.next("#tdc-palette").length?(c.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),b.after(c),c.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var c=jQuery("#tdc-palette"),b=c.prev(".tdc-property-wrap");c.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),c=c.find("input.wp-color-picker"),
c.tdPaletteColorPicker("open_palette",b),c.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var c=jQuery("#tdc-palette"),b=c.prev(".tdc-property-wrap");c.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),c.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",b))},tdcIconWrapHandler:function(c){var b=jQuery(this),d=jQuery("#tdc-icon-selector");d.length||(d=tdcSidebar.buildIconSelector());var a=b.closest(".tdc-property-wrap");c=d.find(".tdc-icon-selector-filter");
var e=d.find(".tdc-icon-selector-lib"),h=d.find(".tdc-icon-selector-content");e.val("");c.val("");h.children().each(function(){jQuery(this).show()});d.data("model_id",b.data("model_id"));d.data("param_name",b.data("param_name"));d.show();a.after(d);b=d.data("param_name");d=tdcIFrameData.getModel(d.data("model_id")).get("attrs");var g="";_.has(d,b)&&(g=d[b].trim());c.focus();h.find("span").each(function(){var a=jQuery(this),b=a.data("font_class");if(g===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=
...
window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(b);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(c){if(-1!==c.indexOf("[caption")){var a=/\[caption(.*)\](.*)\[\/caption\]/g.exec(c);3===a.length&&(c=a[2])}var d=jQuery("img",c).attr("src"),h=a="",g="";"undefined"===typeof d?
(c=jQuery(c),d=c.attr("src"),a=c.attr("class"),h=c.attr("height"),g=c.attr("width")):(c=jQuery("img",c),a=c.attr("class"),h=c.attr("height"),g=c.attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:a,action:"tdc_ajax_get_image_id"}}).done(function(a,c,e){"success"===c&&(_.isObject(a)&&
_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),b.attr("style","background-image: url( '"+d+"') "),b.data("image_link",d),b.data("image_id",a.image_id),b.data("image_height",h),b.data("image_width",g),b.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),c="",e=b.data("model_id"),e=tdcIFrameData.getModel(e),b.hasClass("tdc-no-image-selected")||(c=a.image_id.toString()),
a=e.get("attrs"),a.media_size_image_height=h,a.media_size_image_width=g,e.set("attrs",a),tdcSidebarController.onUpdate(e,b.data("param_name"),"",c)))}).fail(function(a,b,c){})};return!1},tdcImageRemoveHandler:function(c){var b=jQuery(c.currentTarget);c=b.closest(".tdc-property-wrap").find(".tdc-image-wrap");b.addClass("tdc-hidden-button");c.addClass("tdc-no-image-selected");jQuery.removeData(c,"image_link");c.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'");
b=c.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,c.data("param_name"),"","")},tdcInheritSelectHandler:function(c){c=jQuery(c.currentTarget);var b=c.closest(".tdc-property-wrap"),d=b.find("[data-responsive]"),a=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all");b.hasClass("tdc-property-dropdown-responsive")&&(b.hasClass("tdc-visual-selector")?(d=b.find("[data-responsive]:checked:first"),d.length&&d.prop("checked",!1),"undefined"===typeof a?(b.removeClass("tdc-css-inherited"),
d=b.find("[data-responsive]:first")):(b.addClass("tdc-css-inherited"),d=b.find('[data-responsive][value="'+a+'"]')),d.length&&d.prop("checked",!0)):"undefined"===typeof a?(b.removeClass("tdc-css-inherited"),d.find("option:selected").removeAttr("selected").find("option:first").attr("selected","selected")):(b.addClass("tdc-css-inherited"),d.val(a)),b=tdcSidebarPanel.deleteResponsiveValue(d.attr("name"),tdcSidebar.currentViewportSettings.name),a=tdcIFrameData.getModel(d.data("model_id")),d=d.data("param_name"),
tdcSidebarController.onUpdate(a,d,"",b));c.hide()},tdcInheritCheckboxHandler:function(c){c=jQuery(c.currentTarget);var b=c.closest(".tdc-property-wrap"),d=b.find("[data-responsive]"),a=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all");b.hasClass("tdc-property-checkbox-responsive")&&("undefined"===typeof a?(b.removeClass("tdc-css-inherited"),d.removeAttr("checked")):(""===a?d.removeAttr("checked"):d.attr("checked","checked"),b.addClass("tdc-css-inherited")),b=tdcSidebarPanel.deleteResponsiveValue(d.attr("name"),
tdcSidebar.currentViewportSettings.name),a=tdcIFrameData.getModel(d.data("model_id")),d=d.data("param_name"),tdcSidebarController.onUpdate(a,d,"",b));c.hide()},toggleEnableListMenuDepthParam:function(c){c=c.val();var b=jQuery(".tdc-list-menu-depth");""===c||"accordion"===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled")},toggleEnableGalleryACFfieldParam:function(c){var b=c.val();c=c.closest(".tdc-tab-content").find(".tdc-property-acf_field");
"acf_field"===b?c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):c.hasClass("tdc-disabled")||c.addClass("tdc-disabled")},toggleEnableTDSMenuLoginDrodownOnlyParams:function(c){var b=jQuery(".tdc-ml-do-show"),d=jQuery(".tdc-ml-do-hide"),a=jQuery('.tdc-ml-disable-dropdown input[type="checkbox"]');c.is(":checked")?(b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"),d.hasClass("tdc-disabled")||d.addClass("tdc-disabled")):a.is(":checked")?(b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"),
d.hasClass("tdc-disabled")||d.addClass("tdc-disabled")):d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled")},toggleEnableFSLinkPostParams:function(c){var b=c.closest(".tdc-property-wrap"),d=jQuery(".tdc-property-make_child");c.is(":checked")?b.hasClass("tdc-disabled")?d.addClass("tdc-disabled"):d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):d.hasClass("tdc-disabled")||d.addClass("tdc-disabled")},toggleEnableBlockSortParams:function(c){c=c.find("option:selected").val();var b=jQuery(".tdc-block-sort-popular-by-day");
b.length&&("popular1"===c||"popular2"===c||"popular3"===c||"popular7"===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"))},bindPanelToModel:function(c,b){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==c.cid||!_.isUndefined(b)&&(_.isUndefined(b)||!0===b)){b=window.tdcAdminSettings.mappedShortcodes[c.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=
c;for(var d=[],a=0;a<b.params.length;a++){var e=tdcSidebarPanel._defaultGroupName;_.isEmpty(b.params[a].group)||(e=b.params[a].group);d.push(e)}d=_.uniq(d);var h=e="",g=tdcSidebar.getCurrentTabId(),m,f;e+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var k=f=m="";for(a=0;a<d.length;a++){h=tdcSidebarPanel._fixGroupName(d[a]);var l=tdcUtil.makeSafeForCSS(h);0===a?(m='<a href="#" data-tab-id="td-tab-'+l+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>',
f='<a href="#" data-tab-id="td-tab-'+l+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(g)||g!=="td-tab-"+l?k+='<a href="#" data-tab-id="td-tab-'+l+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>':(m=f,k+='<a href="#" data-tab-id="td-tab-'+l+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>')}e=e+(m+k)+"</div>";k=f=m=a="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":a=
"selected";break;case "phone":k="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "landscape":m="selected";break;case "portrait":f="selected";break;case "phone":k="selected"}e+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';tdcState.isMobileComposer()?e=e+('<div class="tdc-responsive-all tdc-responsive-tablet-landscape '+a+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div><div class="tdc-responsive-phone ')+
...
e+='<div class="tdc-responsive-phone '+k+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>');e+="</div>";e+="</div>";e+='<div class="tdc-search">';e+='<i class="td-icon-search"></i>';e+='<input type="text" placeholder="Search settings..." />';e+="</div></div>";e+='<div class="tdc-sidebar-sticky-a"></div>';e+='<div class="tdc-sidebar-sticky-b"></div>';e+='<div class="tdc-tab-content-wrap">';k=f=m="";for(a=0;a<d.length;a++){h=tdcSidebarPanel._fixGroupName(d[a]);l=tdcUtil.makeSafeForCSS(h);
h="tdc-tab-no-design";var p=c.get("tag");"css"===l&&(h="tdc-tab-design");0===a?(m='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+l+'">',f='<div class="tdc-tab-content '+h+'" id="td-tab-'+l+'">',l=window.tdcAdminSettings.mappedShortcodes[p].tdc_start_values,c.unset("presetValues"),_.isUndefined(l)||(l=JSON.parse(window.atob(l)),_.isArray(l)&&1<l.length&&c.set("presetValues",l)),c.has("presetValues")&&(l=c.get("presetValues"),k+=tdcSidebarPanel._addPresetValuesSelector(l,c))):
_.isUndefined(g)||g!=="td-tab-"+l?k+='<div class="tdc-tab-content '+h+'" id="td-tab-'+l+'">':(m=f,k+='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+l+'">');k+=tdcSidebarPanel._bindGroupAndGetHtml(d[a],b,c);l=' data-model_id="'+c.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&(k+='<div class="tdc-sidebar-row-buttons">',k+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+l+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',k+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+
l+' title="Get the current styles\' settings">CONSOLE: style presets</div>',k+="</div>");k+="</div>"}e=e+(m+k)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(e);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),
jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),b=a.find("[data-responsive]"),c=b.attr("name"),d=b.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[c]=JSON.parse(e)}catch(v){d={},a.hasClass("tdc-property-textfield-responsive")?""!==b.val()&&(d.all=b.val()):a.hasClass("tdc-property-dropdown-responsive")?a.hasClass("tdc-visual-selector")?(b=a.find("[data-responsive]:checked:first"),b.length?d.all=b.val():(b=a.find("[data-responsive]:first"),
...
(function(){if("vc_row"===c.get("tag")){var a=jQuery("body .tdc-row-col-dropdown select"),b=jQuery("body .tdc-row-stretch-dropdown select"),d=c.get("childCollection");if(!_.isUndefined(d)){d=tdcIFrameData.getChildCollectionWidths(d);_.isUndefined(d)&&(d="11");a.length?a.val(d):(a=jQuery("body .tdc-row-col-dropdown input[value='"+d+"']"),a.length&&a.attr("checked","checked"));a=c.get("attrs");if(_.has(a,"full_width"))var e=a.full_width;_.isUndefined(e)&&(e="");b.val(e)}}})();(function(){if("vc_row_inner"===
c.get("tag")){var a=jQuery("body .tdc-innerRow-col-dropdown select"),b=c.get("childCollection");if(!_.isUndefined(b)){b=tdcIFrameData.getChildCollectionWidths(b);_.isUndefined(b)&&(b="11");var d=c.get("parentModel").get("attrs"),e="";_.has(d,"width")&&(e=d.width.replace("/",""));if(a.length)switch(a.val(b),e){case "":case "11":a.find("option[value=12_12]").addClass("tdc-block-col");a.find("option[value=23_13]").removeClass("tdc-block-col");a.find("option[value=13_23]").removeClass("tdc-block-col");
a.find("option[value=13_13_13]").removeClass("tdc-block-col");break;case "13":a.find("option[value=12_12]").addClass("tdc-block-col");a.find("option[value=23_13]").addClass("tdc-block-col");a.find("option[value=13_23]").addClass("tdc-block-col");a.find("option[value=13_13_13]").addClass("tdc-block-col");break;case "23":a.find("option[value=12_12]").removeClass("tdc-block-col"),a.find("option[value=23_13]").addClass("tdc-block-col"),a.find("option[value=13_23]").addClass("tdc-block-col"),a.find("option[value=13_13_13]").addClass("tdc-block-col")}else if(a=
jQuery('body .tdc-innerRow-col-dropdown input[value="'+b+'"]'),a.length)switch(a.attr("checked","checked"),a.next("label").show(),e){case "":case "11":a.parent().find("input[value=12_12] + label").addClass("tdc-block-col");a.parent().find("input[value=23_13] + label").removeClass("tdc-block-col");a.parent().find("input[value=13_23] + label").removeClass("tdc-block-col");a.parent().find("input[value=13_13_13] + label").removeClass("tdc-block-col");break;case "13":a.parent().find("input[value=12_12] + label").addClass("tdc-block-col");
a.parent().find("input[value=23_13] + label").addClass("tdc-block-col");a.parent().find("input[value=13_23] + label").addClass("tdc-block-col");a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":a.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),a.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})();
(function(){var a=c.get("tag");if("vc_row"===a||"vc_row_inner"===a||"vc_column"===a||"vc_column_inner"===a){a=jQuery("body .tdc-property-flex_layout");var b=c.get("childCollection");if(!_.isUndefined(b)&&a.length){b=jQuery("body .tdc-property-flex_horiz_align");var d=jQuery("body .tdc-property-flex_vert_align"),e=jQuery("body .tdc-property-flex_layout_reverse");a.find("input[value=column]").is(":checked")&&(b.addClass("tdc-flex-row-align-rev"),d.addClass("tdc-flex-row-align-rev"),e.find("input").is(":checked")&&
b.addClass("tdc-flex-row-rev-align-rev"))}}})();(function(){if("td_woo_products_live_search"===c.get("tag")){var a=jQuery("body .tdc-property-woo_search_version select").val(),b=jQuery("body .tdc-woos-dropdown"),d=jQuery("body .tdc-woos-regular");""===a?d.hide():"regular"===a&&b.hide()}})();b=jQuery(".tdc-property-wrap[data-enable-params] textarea,.tdc-property-wrap[data-enable-params] input[type=text]");b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableParamsFromText(jQuery(b))});b=jQuery(".tdc-property-wrap[data-enable-params] select");
...
b=jQuery(".tdc-gallery-source select");b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableGalleryACFfieldParam(jQuery(b))});b=jQuery('.tdc-ml-dropdown-only input[type="checkbox"]');b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableTDSMenuLoginDrodownOnlyParams(jQuery(b))});b=jQuery('.tdc-fs-link-post-toggle input[type="checkbox"]');b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableFSLinkPostParams(jQuery(b))});b=jQuery(".tdc-block-sort select");b.length&&b.each(function(a,
b){tdcSidebarPanel.toggleEnableBlockSortParams(jQuery(b))})}},_bindGroupAndGetHtml:function(c,b,d){var a="",e=d.get("attrs");if("tdc_zone"===d.get("tag"))var h=e.type;for(var g=0;g<b.params.length;g++){var m=b.params[g].param_name,f=b.params[g].group;if(c===tdcSidebarPanel._defaultGroupName&&_.isEmpty(b.params[g].group)||b.params[g].group===c){if(!_.isUndefined(h)&&(!_.isUndefined(b.params[g].zone_group)&&h!==b.params[g].zone_group||"type"===m))continue;a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[g],
d)}if("block_template_id"===m){f=e.block_template_id;_.isEmpty(f)&&(f=window.tdcAdminSettings.globalBlockTemplate);m=window.tdcAdminSettings.mappedBlockTemplates;for(var k=0;k<m[f].params.length;k++)if(c===tdcSidebarPanel._defaultGroupName&&_.isEmpty(m[f].params[k].group)||m[f].params[k].group===c)a+=tdcSidebarPanel._bindParamAndGetHtml(m[f].params[k],d)}else if(0===m.indexOf("tds_")){var l=m.split("-");k=l[0];var p;2===l.length?p=l[1]:2<l.length&&new tdcNotice.notice('Param "'+m+'" must have up to at most one "-" separator ',
...
e=!1;_.has(c,"tdc_dropdown_images")&&""!==c.tdc_dropdown_images&&(e=!0);_.has(c,"tdc_dropdown_texts")&&""!==c.tdc_dropdown_texts&&(h=!0);var g="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(g='data-enable-params="'+c.toggle_enable_params+'"');var m="";_.has(c,"toggle_disable_params")&&""!==c.toggle_disable_params&&(m='data-disable-params="'+c.toggle_disable_params+'"');var f="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(f='data-enable-params-reverse="1"');
var k="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(k='data-enabled-by="'+c.toggle_enabled_by+'"');var l="";_.has(c,"toggle_disabled_by")&&""!==c.toggle_disabled_by&&(l='data-disabled-by="'+c.toggle_disabled_by+'"');var p="",q="",r=Object.keys(c.value);if(_.has(c,"tdc_min_options")&&r.length<=parseInt(c.tdc_min_options))return p;for(var u=0;u<r.length;u++){var x=!1,t="",v="",C="",z="",w="",y=r[u],A=String(tdcSidebarPanel._getParameterCurrentValue(c,b)),B=String(c.value[r[u]]);_.has(c,
"options_to_disable")&&""!==c.options_to_disable&&(v=c.options_to_disable);_.has(c,"options_to_hide")&&""!==c.options_to_hide&&(C=c.options_to_hide);_.isObject(c.value[r[u]])&&(x=!0,B=_.values(c.value[r[u]])[0],y=_.keys(c.value[r[u]])[0]);if(e||h)0===u&&""===A&&(A=B),A===B&&(t=" checked "),v=_.uniqueId(),C=B,"vc_row"!==b.attributes.tag&&"vc_row_inner"!==b.attributes.tag||-1!==c.param_name.indexOf("flex_")||(C="col_"+C),q+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(c,
b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+t+' value="'+B+'">',e?(t="",x&&(t="tdc-standard-value"),q+='<label class="tdc-property-input-radio-label '+t+'" for="'+v+'" title="'+y+'"><div class="'+C+'"></div></label>'):q+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+y+'">'+B+"</label>";else{A===B&&(t=' selected="selected" ');if("__"===B&&-1!==y.search("--")||-1<v.indexOf(B)&&""!==B)z=" disabled ";-1<C.indexOf(B)&&""!==B&&(w=' style="display:none" ');
q+="<option "+t+" "+z+w+' value="'+B+'">'+y+"</option>"}}r="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':r=' title="'+c.description+'" ');p+='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+g+" "+m+" "+f+" "+k+" "+l+">";p+='<div class="tdc-property-title"><span class="tdc-search-data"'+r+">"+c.heading+"</span>";d="";a="#";"tdb_flex_block_builder"===b.get("tag")&&"cloud_tpl_module_id"===c.param_name&&(d="tdc-edit-cloud_tpl_module_id",
g='style="margin-left: 10px"',_.has(b.get("attrs"),"cloud_tpl_module_id")?""===b.get("attrs").cloud_tpl_module_id.trim()?g='style="margin-left: 10px; visibility: hidden"':"undefined"!==typeof window.tdData&&(a=tdData.adminUrl+"post.php?post_id="+b.get("attrs").cloud_tpl_module_id.trim()+"&td_action=tdc&tdbTemplateType=module"):g='style="margin-left: 10px; visibility: hidden"',p+='<a href="'+a+'" class="'+d+'" target="_blank" '+g+">Edit</a>");p+='</div><div class="tdc-property">';e||h?p+=q:(p+="<select "+
tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" class="'+d+'">',p=p+q+"</select>");p=p+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return p+"</div>"},addDropDownResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e=!1,h=!1;_.has(c,"tdc_dropdown_images")&&""!==c.tdc_dropdown_images&&(e=!0);_.has(c,"tdc_dropdown_texts")&&""!==c.tdc_dropdown_texts&&(h=!0);var g="";_.has(c,
"toggle_enable_params")&&""!==c.toggle_enable_params&&(g='data-enable-params="'+c.toggle_enable_params+'"');var m="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(m='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(f='data-enabled-by="'+c.toggle_enabled_by+'"');var k="",l="",p=Object.keys(c.value);if(_.has(c,"tdc_min_options")&&p.length<=parseInt(c.tdc_min_options))return k;var q=' data-responsive="" ',r=String(tdcSidebarPanel._getParameterCurrentValue(c,
b));try{var u=JSON.parse(window.atob(r));q=' data-responsive="'+r+'" ';"undefined"!==typeof u[tdcSidebar.currentViewportSettings.name]&&(r=u[tdcSidebar.currentViewportSettings.name])}catch(y){}for(u=0;u<p.length;u++){var x=!1,t="",v="",C=p[u],z=String(c.value[p[u]]);_.isObject(c.value[p[u]])&&(x=!0,z=_.values(c.value[p[u]])[0],C=_.keys(c.value[p[u]])[0]);if(e||h){0===u&&""===r&&(r=z);r===z&&(t=" checked ");v=_.uniqueId();var w=z;"vc_row"!==b.attributes.tag&&"vc_row_inner"!==b.attributes.tag||-1!==
c.param_name.indexOf("flex_")||(w="col_"+w);l+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+t+' value="'+z+'" '+q+">";e?(t="",x&&(t="tdc-standard-value"),l+='<label class="tdc-property-input-radio-label '+t+'" for="'+v+'" title="'+C+'"><div class="'+w+'"></div></label>'):l+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+C+'">'+z+"</label>"}else r===z&&(t=' selected="selected" '),
"__"===z.substring(0,2)&&-1!==C.search("--")&&(v=" disabled "),l+="<option "+t+" "+v+' value="'+z+'">'+C+"</option>"}p="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':p=' title="'+c.description+'" ');k+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+g+" "+m+" "+f+">";k+='<div class="tdc-property-title"><span class="tdc-search-data"'+p+">"+c.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';
k+='<div class="tdc-property">';e||h?k+=l:(k+="<select "+tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+q+p+">",k=k+l+"</select>");k=k+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return k+"</div>"},addCheckBox:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+
'" ');var h="",g=tdcSidebarPanel._getParameterCurrentValue(c,b);"product_cat_type_action"===c.param_name?""!==g&&"single_selection"!==g&&(h=" checked "):""!==g&&(h=" checked ");var m="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(m='data-enable-params="'+c.toggle_enable_params+'"');var f="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(f='data-enable-params-reverse="1"');var k="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(k='data-enabled-by="'+
c.toggle_enabled_by+'"');var l="";_.has(c,"toggle_disabled_by")&&""!==c.toggle_disabled_by&&(l='data-disabled-by="'+c.toggle_disabled_by+'"');g="";var p=tdcSidebarPanel._getParameterClasses(c);p.includes("tdc-filter-multiple")&&(g=' title="'+c.description+'" ');d='<div class="'+p+'" '+d+" "+a+" "+m+" "+f+" "+k+" "+l+'><div class="tdc-property-title"><span class="tdc-search-data"'+(e+">"+c.heading+"</span></div>");d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+
tdcSidebarPanel._getParameterDomName(c)+'" type="checkbox" value="yes" '+h+" "+g+"/>");d=d+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return d+"</div>"},addCheckBoxResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="",h=' data-responsive="" ',g=String(tdcSidebarPanel._getParameterCurrentValue(c,b));try{var m=JSON.parse(window.atob(g));h=' data-responsive="'+g+'" ';"undefined"!==typeof m[tdcSidebar.currentViewportSettings.name]&&
(g=m[tdcSidebar.currentViewportSettings.name])}catch(l){}""!==g&&(e=" checked ");m="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':m=' title="'+c.description+'" ');g="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(g='data-enable-params="'+c.toggle_enable_params+'"');var f="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(f='data-enable-params-reverse="1"');var k="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&
(k='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+g+" "+f+" "+k+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+m+">"+c.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+
'" type="checkbox" value="yes" '+e+h+"/>");d=d+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return d+"</div>"},addRange:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"range_max")&&""!==c.range_max&&(h=c.range_max);var g="";_.has(c,"range_min")&&""!==c.range_min&&(g=c.range_min);
var m="";_.has(c,"range_step")&&""!==c.range_step&&(m=c.range_step);var f="";_.has(c,"value")&&""!==c.value&&(f=c.value);var k="";""!==tdcSidebarPanel._getParameterCurrentValue(c,b)&&(k=tdcSidebarPanel._getParameterCurrentValue(c,b));var l="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(l='data-enable-params="'+c.toggle_enable_params+'"');var p="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(p='data-enable-params-reverse="1"');var q="";_.has(c,"toggle_enabled_by")&&
""!==c.toggle_enabled_by&&(q='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+l+" "+p+" "+q+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" data-value="'+k+'" data-min="'+g+'" data-max="'+h+'" data-step="'+m+'" min="'+g+'" max="'+
h+'" step="'+m+'" value="'+k+'" />');d=d+('<input type="text" class="tdc_range_value" data-default_value="'+f+'" value="'+k+'"/></div><span class="tdc-param-name">')+(c.param_name+"</span>");return d+="</div>"},addRangeResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"range_max")&&""!==
c.range_max&&(h=c.range_max);var g="";_.has(c,"range_min")&&""!==c.range_min&&(g=c.range_min);var m="";_.has(c,"range_step")&&""!==c.range_step&&(m=c.range_step);var f="";_.has(c,"value")&&""!==c.value&&(f=c.value);""!==tdcSidebarPanel._getParameterCurrentValue(c,b)&&tdcSidebarPanel._getParameterCurrentValue(c,b);var k="";_.has(c,"placeholder")&&""!==c.placeholder&&(k=' data-placeholder="'+c.placeholder+'" placeholder="'+c.placeholder+'" ');var l="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&
(l='data-enable-params="'+c.toggle_enable_params+'"');var p="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(p='data-enable-params-reverse="1"');var q="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(q='data-enabled-by="'+c.toggle_enabled_by+'"');var r=' data-responsive="" ',u=tdcSidebarPanel._getParameterCurrentValue(c,b);try{var x=JSON.parse(window.atob(u));r=' data-responsive="'+u+'" ';u="undefined"===typeof x[tdcSidebar.currentViewportSettings.name]?
"":x[tdcSidebar.currentViewportSettings.name]}catch(t){}d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+l+" "+p+" "+q+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" data-value="'+u+'" data-min="'+g+'" data-max="'+h+'" data-step="'+m+'" min="'+g+'" max="'+
...
""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');var f=c.tdc_values,k=tdcSidebarPanel._getParameterCurrentValue(c,b),l="",p="",q=[],r="",u="",x="",t="",v="",C="",z="",w;for(w in f)f.hasOwnProperty(w)&&(q.push(f[w].unit),""===u||""===
r)&&(t=f[w].unit,u=' data-range_unit="'+t+'" ',x=f[w].value,r=' data-range_value="'+x+'" ',v=f[w].range_min,C=f[w].range_max,z=f[w].range_step);if(""!==k){for(var y=[],A=0;A<q.length&&!(y=k.split(q[A]),1<y.length);A++);y.length&&(t=q[A],u=' data-range_unit="'+t+'" ',x=y[0],r=' data-range_value="'+x+'" ')}for(w in f)f.hasOwnProperty(w)&&(k=_.uniqueId(),l+=" data-value_"+w+'="'+f[w].value+'" ',l+=" data-min_"+w+'="'+f[w].range_min+'" ',l+=" data-max_"+w+'="'+f[w].range_max+'" ',l+=" data-step_"+w+'="'+
f[w].range_step+'" ',q=f[w].value,y="",f[w].unit===t&&(q=x,v=f[w].range_min,C=f[w].range_max,z=f[w].range_step,y="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+'_unit" data-unit="'+w+'" data-unit_value="'+f[w].unit+'" type="radio" id="'+k+'" '+y+' data-default_value="'+f[w].value+'" data-last_value="'+q+'"/>',p+='<label for="'+k+'">'+f[w].unit+"</label>");d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+
e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+r+" "+u+" "+l+' min="'+v+'" max="'+C+'" step="'+z+'" value="'+x+'"/>');d=d+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+p+'</div><input type="text" class="tdc_range_value" value="'+(x+'"/>');d+="</div>";d+="</div>";d+='<span class="tdc-param-name">'+c.param_name+
"</span>";return d+="</div>"},addRangeMultipleResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&
(g='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');var f=c.tdc_values,k=tdcSidebarPanel._getParameterCurrentValue(c,b),l="",p="",q=[],r=' data-responsive="" ',u="",x="",t="",v="",C="",z="",w="",y;for(y in f)f.hasOwnProperty(y)&&(q.push(f[y].unit),""===x||""===u)&&(v=f[y].unit,x=' data-range_unit="'+v+'" ',t=f[y].value,u=' data-range_value="'+t+'" ',C=f[y].range_min,z=f[y].range_max,w=f[y].range_step);
if(""!==k){var A=k;try{var B=JSON.parse(window.atob(k));r=' data-responsive="'+k+'" ';A="undefined"===typeof B[tdcSidebar.currentViewportSettings.name]?"":B[tdcSidebar.currentViewportSettings.name]}catch(D){}if(""!==A){k=[];for(B=0;B<q.length&&!(k=A.split(q[B]),1<k.length);B++);k.length&&(v=q[B],x=' data-range_unit="'+v+'" ',t=k[0],u=' data-range_value="'+t+'" ')}}for(y in f)f.hasOwnProperty(y)&&(q=_.uniqueId(),l+=" data-value_"+y+'="'+f[y].value+'" ',l+=" data-min_"+y+'="'+f[y].range_min+'" ',l+=
" data-max_"+y+'="'+f[y].range_max+'" ',l+=" data-step_"+y+'="'+f[y].range_step+'" ',A=f[y].value,k="",f[y].unit===v&&(A=t,C=f[y].range_min,z=f[y].range_max,w=f[y].range_step,k="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+'_unit" data-unit="'+y+'" data-unit_value="'+f[y].unit+'" type="radio" id="'+q+'" '+k+' data-default_value="'+f[y].value+'" data-last_value="'+A+'"/>',p+='<label for="'+q+'">'+f[y].unit+"</label>");d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+
'" '+d+" "+a+" "+h+" "+g+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+u+" "+x+" "+l+" "+r+' min="'+C+'" max="'+z+'" step="'+w+'" value="'+t+'"/>');d=d+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+p+'</div><input type="text" class="tdc_range_value" value="'+
(t+'"/>');d+="</div>";d+="</div>";d+='<span class="tdc-param-name">'+c.param_name+"</span>";return d+="</div>"},addIconSelector:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,
"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(f='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+f+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+(tdcSidebarPanel._getParamterDataAtts(c,
b)+' data-selected_icon="'+tdcSidebarPanel._getParameterCurrentValue(c,b)+'">');d=d+'</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(c.param_name+"</span>");d+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-icon-wrap").each(function(a,d){a=jQuery(d);c.param_name===a.data("param_name")&&(d=jQuery("#tdc-icon-selector"),d.length||(d=tdcSidebar.buildIconSelector()),d=d.find('.tdc-icon-selector-content > span[data-font_class="'+
tdcSidebarPanel._getParameterCurrentValue(c,b)+'"]'),""!==tdcSidebarPanel._getParameterCurrentValue(c,b)&&(a.html(d.html()),a.closest(".tdc-property").find(".tdc-icon-remove").removeClass("tdc-hidden-button")))})});return d},addUploadImage:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"toggle_enable_params")&&
""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(f='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+f+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";
d=d+'<div class="tdc-property"><div class="tdc-image-wrap tdc-no-image-selected" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");d=d+'</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(c.param_name+"</span>");d+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(a,d){var e=jQuery(d);
...
new tdcNotice.notice(a.errors,!0,!1):(e.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),e.data("image_link",a.image_url),e.data("image_id",g),e.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,b,c){})}})});return d},addTextField:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="",h="";if(_.has(c,"description")&&""!==c.description)if(""!==
d)a='data-info-descr="'+c.description+'"';else{var g=jQuery("<div>"+c.description+"</div>");c.description===g.text()?e=' title="'+c.description+'" ':h='<div class="tdc-description">'+c.description+"</div>"}g="";_.has(c,"placeholder")&&""!==c.placeholder&&(g=' data-placeholder="'+c.placeholder+'" placeholder="'+c.placeholder+'" ');var f=tdcSidebarPanel._getParameterCurrentValue(c,b);if(""===f){var n=Math.floor(65536*(1+Math.random())).toString(16).substring(1);"modal_id"===c.param_name?(f="td_m_"+
n,tdcSidebarController.onUpdate(b,"modal_id","",f)):"tc_id"===c.param_name&&(f="td_tc_"+n,tdcSidebarController.onUpdate(b,"tc_id","",f))}"undefined"!==typeof f&&null!==f&&0===f.toString().indexOf("td_encval")&&(f=f.replace("td_encval",""),f=window.atob(f));n="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(n='data-enable-params="'+c.toggle_enable_params+'"');var k="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');
var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+n+" "+k+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span>";e="";a="#";"tdm_block_popup"===b.get("tag")&&"page_id"===c.param_name&&(e="tdc-edit-page_id",n='style="margin-left: 10px"',_.has(b.get("attrs"),"page_id")?""===b.get("attrs").page_id.trim()?n='style="margin-left: 10px; visibility: hidden"':
"undefined"!==typeof window.tdData&&(a=tdData.adminUrl+"post.php?post="+b.get("attrs").page_id.trim()+"&action=edit"):n='style="margin-left: 10px; visibility: hidden"',d+='<a href="'+a+'" class="'+e+'" target="_blank" '+n+">Edit</a>");d=d+'</div><div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="text" '+g+' value="'+f+'" class="'+e+'" />');d=d+h+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return d+=
"</div>"},addDoShortcode:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e=_.uniqueId("tdc_textarea_"),h="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':h=' title="'+c.description+'" ');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+">";d+='<div class="tdc-property-title"><span'+h+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><textarea id="'+(e+'" class="tdc-textarea tdc-textarea-visible" '+
tdcSidebarPanel._getParamterDataAtts(c,b)+">"+decodeURIComponent(atob(tdcSidebarPanel._getParameterCurrentValue(c,b)))+"</textarea>");d=d+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");d+="</div>";c=jQuery("body");c.on("change","#woo_shortcode",function(a){jQuery(a.change);a=atob(a.target.value);jQuery("#"+e).val(a).trigger("focusin")});c.on("keyup focusin","#"+e,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id")),d=window.btoa(encodeURIComponent(b.val())),
e=window.btoa(encodeURIComponent(a.target.oldValue));setTimeout(function(){tdcSidebarController.onUpdate(c,b.data("param_name"),e,d)},500)});return d},addTextFieldResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="",h="";if(_.has(c,"description")&&""!==c.description)if(""!==d)a='data-info-descr="'+c.description+'"';else{var g=jQuery("<div>"+c.description+"</div>");c.description===g.text()?e=' title="'+c.description+'" ':h='<div class="tdc-description">'+
c.description+"</div>"}g="";_.has(c,"placeholder")&&""!==c.placeholder&&(g=' data-placeholder="'+c.placeholder+'" placeholder="'+c.placeholder+'" ');var f="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(f='data-enable-params="'+c.toggle_enable_params+'"');var n="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');var k="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(k='data-enabled-by="'+c.toggle_enabled_by+
'"');var l=' data-responsive="" ',p=tdcSidebarPanel._getParameterCurrentValue(c,b);try{var q=JSON.parse(window.atob(p));l=' data-responsive="'+p+'" ';p="undefined"===typeof q[tdcSidebar.currentViewportSettings.name]?"":q[tdcSidebar.currentViewportSettings.name]}catch(r){}d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+f+" "+n+" "+k+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input '+
(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="text" value="'+p+'" '+g+l+e+"/>");d=d+h+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return d+="</div>"},addTextArea:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e=_.uniqueId("tdc_textarea_"),h="",g="";if(_.has(c,"description")&&""!==c.description)if(""!==d)a='data-info-descr="'+c.description+'"';else{var f=jQuery("<div>"+
...
var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+n+" "+k+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><textarea id="'+(e+'" class="tdc-textarea tdc-textarea-visible" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+f+'">'+
tdcSidebarPanel._getParameterCurrentValue(c,b)+"</textarea>");d=d+g+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");d+="</div>";jQuery("body").on("keyup focusin","#"+e,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id"));if("focusin"!==a.type&&a.target.oldValue!==a.target.value){var d=b.val(),e=a.target.oldValue;tdcSidebarController.onUpdate(c,b.data("param_name"),e,d)}a.target.oldValue=a.target.value});return d},addTextAreaHtml:function(c,b){_.has(c,"description");
...
g='<div class="tdc-description">'+c.description+"</div>"}f="";_.has(c,"placeholder")&&""!==c.placeholder&&(f=' data-placeholder="'+c.placeholder+'" placeholder="'+c.placeholder+'" ');var n="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(n='data-enable-params="'+c.toggle_enable_params+'"');var k="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+
c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+n+" "+k+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><textarea id="'+(e+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(c,b)+" "+f+">"+tdcSidebarPanel._getParameterCurrentValue(c,b)+"</textarea>");d=d+g+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");d+="</div>";jQuery.ajax({timeout:1E4,
type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(c,b)}}).done(function(a,b,c){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):jQuery("#"+e).html(a.parsed_content).addClass("tdc-textarea-visible"))}).fail(function(a,
b,c){});jQuery("body").on("keyup focusin","#"+e,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id"));if("focusin"!==a.type&&a.target.oldValue!==a.target.value){var d=window.btoa(encodeURIComponent(b.val())),e=window.btoa(encodeURIComponent(a.target.oldValue));tdcSidebarController.onUpdate(c,b.data("param_name"),e,d)}a.target.oldValue=a.target.value});return d},addTextAreaRawHtmlAce:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+
'"');var e=_.uniqueId("tdc_textarea_");_.has(c,"description")&&""!==c.description&&""!==d&&(a='data-info-descr="'+c.description+'"');var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(f='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+
tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+f+">";d=d+'<div class="tdc-property-editor_expand"><span></span><div class="tdc-editor-toggle tdc-html-ace-editor-expand-collapse"></div></div><div class="tdc-property tdc-raw-html-ace"><textarea id="'+(e+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(c,b)+">"+tdcSidebarPanel._getParameterCurrentValue(c,b)+"</textarea>");d=d+('<div id="'+e+'_ace_html" class="tdc-raw-html-ace-editor"></div></div><span class="tdc-param-name">')+
(c.param_name+"</span>");d+="</div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(c,b)}}).done(function(a,b,c){if("success"===b)if(_.isObject(a)&&_.has(a,"errors"))new tdcNotice.notice(a.errors,
!0,!1);else{var d=jQuery("#"+e);d.html(a.parsed_content);var g=ace.edit(e+"_ace_html");g.$blockScrolling=Infinity;g.getSession().setValue(d.val());g.getSession().on("change",function(){var a=g.getSession().getValue(),b=tdcIFrameData.getModel(d.data("model_id")),c=d.data("param_name");d.val(a);a=window.btoa(encodeURIComponent(a));tdcSidebarController.onUpdate(b,c,"",a)});g.setTheme("ace/theme/textmate");g.getSession().setMode("ace/mode/html");g.setOptions({enableBasicAutocompletion:!0,enableSnippets:!0,
wrap:!0,indentedSoftWrap:!1,fontSize:11});var h=jQuery("#tdc-ace-editor"),f=jQuery(".tdc-property-textarea_raw_html_ace .tdc-raw-html-ace"),k=h.children(".content");jQuery("body").on("click",".tdc-html-ace-editor-expand-collapse",function(){jQuery(".tdc-property-textarea_raw_html_ace .tdc-property-editor_expand").addClass("disabled");h.find("header .title").text("HTML Code Editor");h.addClass("tdc-html-ace-editor-expand");k.empty();k.append(jQuery("#"+e+"_ace_html"));h.show();tdcWindowFrame.setWindowFrame(h);
g.resize();setTimeout(function(){g.focus()},100)}).on("click",".tdc-html-ace-editor-expand .close",function(){h.removeClass("tdc-html-ace-editor-expand");h.hide();f.append(jQuery("#"+e+"_ace_html"));jQuery(".tdc-property-textarea_raw_html_ace .tdc-property-editor_expand").removeClass("disabled");tdcWindowFrame.unsetWindowFrame(h);g.resize()}).on("tdcWindowFrameResize",function(){g.resize(!0)})}}).fail(function(a,b,c){});return d},addEditorCss:function(c,b){var d=_.uniqueId("tdc_textarea_"),a="";_.has(c,
"description")&&""!==c.description&&(a=' title="'+c.description+'" ');var e='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'">';e+='<div class="tdc-property-title" data-status="loading" data-clean-title="'+c.heading+'"><span class="tdc-search-data tdc-open-csseditor"'+a+">"+c.heading+" (Loading ...)</span></div>";e=e+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea tdc-editor-css" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' style="display: none">'+tdcSidebarPanel._getParameterCurrentValue(c,
b)+"</textarea>");e=e+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");e+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackEditorCss)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackEditorCss);jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce);a=jQuery("#"+
d).parent().siblings(".tdc-property-title");a.length&&a.data("status","loading")},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(c,b)}}).done(function(b,c,e){"success"===c&&(_.isObject(b)&&_.has(b,"errors")?new tdcNotice.notice(b.errors,!0,!1):(c=jQuery("#"+d),e=c.parent().siblings(".tdc-property-title"),c.html(b.parsed_content).addClass("tdc-textarea-visible"),e.length&&(e.data("status","ready"),
e.html('<span class="tdc-search-data tdc-open-csseditor"'+a+">"+e.data("clean-title")+" (Ready)</span>"),"undefined"!==typeof e.data("open")&&(e.removeData("open"),e.trigger("click")))))}).fail(function(a,b,c){});var h=jQuery("#tdc-ace-editor"),g=h.children(".content");jQuery("body").on("click",".tdc-css-ace-editor-expand-collapse",function(){jQuery(".tdc-property-editor_css .tdc-property-title").addClass("disabled");jQuery(".tdc-property-editor_css-title").addClass("disabled");h.find("header .title").text("CSS Code Editor");
h.addClass("tdc-css-ace-editor-expand");g.empty();g.append(tdcSidebar.$_editorCss);h.show();tdcWindowFrame.setWindowFrame(h);tdcSidebar.editorCss.resize();setTimeout(function(){tdcSidebar.editorCss.focus()},100)}).on("click",".tdc-css-ace-editor-expand .close",function(){h.removeClass("tdc-css-ace-editor-expand");h.hide();jQuery(".tdc-property-editor_css-title").after(tdcSidebar.$_editorCss);jQuery(".tdc-property-editor_css-title, .tdc-property-editor_css .tdc-property-title").removeClass("disabled");
tdcWindowFrame.unsetWindowFrame(h);tdcSidebar.editorCss.resize()}).on("tdcWindowFrameResize",function(){tdcSidebar.editorCss.resize(!0)});return e},addSeparatorHorizontal:function(c,b){return'<div class="tdc-sidebar-horizontal-separator '+tdcSidebarPanel._getParameterClasses(c)+'"></div>'},addTextSeparatorHorizontal:function(c,b){var d=b="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(d='data-enable-params="'+c.toggle_enable_params+'"');var a="";_.has(c,"toggle_enable_params_reverse")&&
!0===c.toggle_enable_params_reverse&&(a='data-enable-params-reverse="1"');var e="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(e='data-enabled-by="'+c.toggle_enabled_by+'"');return b+='<div class="tdc-sidebar-text-separator tdc-property-title '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+e+'><span class="tdc-search-data">'+c.heading+"</span></div>"},addFontHeader:function(c,b){var d=b="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(d='data-enable-params="'+
c.toggle_enable_params+'"');var a="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(a='data-enable-params-reverse="1"');var e="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(e='data-enabled-by="'+c.toggle_enabled_by+'"');return b+='<div class="tdc-sidebar-font-header '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+e+'><span class="tdc-font-ico1" title="Font size"></span><span class="tdc-font-ico2" title="Line height (Use with px or a number that will be multiplied with the current font-size)"></span><span class="tdc-font-ico3" title="Font style"></span><span class="tdc-font-ico4" title="Font weight"></span><span class="tdc-font-ico5" title="Text transform"></span><span class="tdc-font-ico6" title="Letter spacing"></span></div>'},
addFontTitle:function(c,b){var d="",a="",e="";_.has(c,"info_img")&&""!==c.info_img&&(a='data-info-img="'+c.info_img+'"',_.has(c,"description")&&""!==c.description&&(e='data-info-descr="'+c.description+'"'));var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&
(f='data-enabled-by="'+c.toggle_enabled_by+'"');return d+='<div class="tdc-sidebar-font-title '+tdcSidebarPanel._getParameterClasses(c)+'" '+a+" "+e+" "+h+" "+g+" "+f+'><span class="tdc-search-data tdc-search-notice-font">'+tdcSidebarPanel._getParameterCurrentValue(c,b)+"</span></div>"},addFontSettings:function(c,b){var d="",a="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(a='data-enable-params="'+c.toggle_enable_params+'"');var e="";_.has(c,"toggle_enable_params_reverse")&&!0===
c.toggle_enable_params_reverse&&(e='data-enable-params-reverse="1"');var h="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(h='data-enabled-by="'+c.toggle_enabled_by+'"');d+='<div class="tdc-font-manager-wrap '+tdcSidebarPanel._getParameterClasses(c)+'" '+a+" "+e+" "+h+">";d=d+'<div class="tdc-font-manager"><div title="Clear font settings" class="tdc-sidebar-font-reset" data-model_id="'+(b.cid+'" data-param_name="'+c.param_name+'">Reset font settings</div>');d+='<div title="Save font settings" class="tdc-sidebar-font-save" data-model_id="'+
...
t=b.find(".tdc-css-border-radius").val().trim(),v=b.find(".tdc-css-width").val().trim(),C=b.find(".tdc-css-height").val().trim(),z=b.find(".tdc-css-shadow-size").val().trim(),w=b.find(".tdc-css-shadow-offset-h").val().trim(),y=b.find(".tdc-css-shadow-offset-v").val().trim(),A=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),D=b.find(".tdc-css-z-index").val().trim(),E="";b.find(".tdc-css-order").length&&(E=b.find(".tdc-css-order").val().trim());""!==d&&(a["margin-top"]=
...
f);d=b.find(".tdc-css-border-color");f=d.val().trim();""!==f?a["border-color"]=f:(d=d.data("no_value"),c.isUndefined(d)||1!==d||(a["border-color"]="no_value"));""!==t&&(a["border-radius"]=t);""!==v&&(a.width=v);""!==C&&(a.height=C);""!==z&&(a["shadow-size"]=z);t=b.find(".tdc-css-shadow-color");v=t.val().trim();""!==v?a["shadow-color"]=v:(t=t.data("no_value"),c.isUndefined(t)||1!==t||(a["shadow-color"]="no_value"));""!==w&&(a["shadow-offset-h"]=w);""!==y&&(a["shadow-offset-v"]=y);w=b.find(".tdc-css-bg-color");
...
1!==A||(a["color-2-overlay"]="no_value"));""!==B&&(a["gradient-direction"]=B);""!==E&&(a.order=E);""!==D&&(a["z-index"]=D);B=b.find(".tdc-css-content-h-align");D=B.val().trim();""===D||B.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["content-h-align"]=D);b=b.find(".tdc-css-display");a.display=b.val().trim();c.isUndefined(tdcCssEditor._currentCssSettings)&&(tdcCssEditor._currentCssSettings={});c.isUndefined(a["border-style"])||"solid"!==a["border-style"]||("all"===tdcSidebar.currentViewportSettings.name||
...
!1,v=c.tdcAdminSettings.tdcSavings.gradients.length-1;0<=v;v--){var C=c.tdcAdminSettings.tdcSavings.gradients[v];try{var z=JSON.parse(c.atob(C));"undefined"!==typeof z.css&&(t=!0,f('<div class="tdc-gradient-value" style="'+z.css+'" data-gradient="'+C+'"><div class="tdc-gradient-value-delete"></div></div>').appendTo(x))}catch(y){}}t||u.hide();a.$container=m;a.$gradientResult=r;if("undefined"!==typeof c.tdc_wm_global_colors){var w=f('<div class="tdc-global-colors-values"></div>').insertAfter(m.find(".tdc-gradient-values-wrapper"));
