...
l=b.find(".tdc-css-box-input-margin-left").val().trim(),n=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),q=b.find(".tdc-css-box-input-border-left-width").val().trim(),p=b.find(".tdc-css-box-input-padding-top").val().trim(),k=b.find(".tdc-css-box-input-padding-right").val().trim(),r=b.find(".tdc-css-box-input-padding-bottom").val().trim(),w=b.find(".tdc-css-box-input-padding-left").val().trim(),
u=b.find(".tdc-css-border-radius").val().trim(),z=b.find(".tdc-css-width").val().trim(),B=b.find(".tdc-css-height").val().trim(),C=b.find(".tdc-css-shadow-size").val().trim(),t=b.find(".tdc-css-shadow-offset-h").val().trim(),v=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),A=b.find(".tdc-css-gradient-direction").val().trim(),D=b.find(".tdc-css-z-index").val().trim(),E="";b.find(".tdc-css-order").length&&(E=b.find(".tdc-css-order").val().trim());""!==d&&(c["margin-top"]=
d);""!==f&&(c["margin-right"]=f);""!==g&&(c["margin-bottom"]=g);""!==l&&(c["margin-left"]=l);""!==n&&(c["border-top-width"]=n);""!==h&&(c["border-right-width"]=h);""!==m&&(c["border-bottom-width"]=m);""!==q&&(c["border-left-width"]=q);""!==p&&(c["padding-top"]=p);""!==k&&(c["padding-right"]=k);""!==r&&(c["padding-bottom"]=r);""!==w&&(c["padding-left"]=w);d=b.find(".tdc-css-border-style");f=d.val().trim();""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["border-style"]=
f);d=b.find(".tdc-css-border-color");f=d.val().trim();""!==f?c["border-color"]=f:(d=d.data("no_value"),a.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==u&&(c["border-radius"]=u);""!==z&&(c.width=z);""!==B&&(c.height=B);""!==C&&(c["shadow-size"]=C);u=b.find(".tdc-css-shadow-color");z=u.val().trim();""!==z?c["shadow-color"]=z:(u=u.data("no_value"),a.isUndefined(u)||1!==u||(c["shadow-color"]="no_value"));""!==t&&(c["shadow-offset-h"]=t);""!==v&&(c["shadow-offset-v"]=v);t=b.find(".tdc-css-bg-color");
...
1!==y||(c["color-2-overlay"]="no_value"));""!==A&&(c["gradient-direction"]=A);""!==E&&(c.order=E);""!==D&&(c["z-index"]=D);A=b.find(".tdc-css-content-h-align");D=A.val().trim();""===D||A.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["content-h-align"]=D);b=b.find(".tdc-css-display");c.display=b.val().trim();a.isUndefined(tdcCssEditor._currentCssSettings)&&(tdcCssEditor._currentCssSettings={});a.isUndefined(c["border-style"])||"solid"!==c["border-style"]||("all"===tdcSidebar.currentViewportSettings.name||
...
function(a){var b=jQuery(this),c=b.closest(".tdc-property-responsive"),d=c.find('input[type="range"]'),f=c.find('input[type="radio"]:checked'),g=c.find('input[type="text"]'),l=d.get(0),n="",h=f.data("default_value"),m=tdcIFrameData.getModel(d.data("model_id")),q=d.data("param_name"),p=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],k=m="";var r=[];for(var w=0;w<p.params.length;w++)if(q===p.params[w].param_name){w=p.params[w].tdc_values;for(var u in w)w.hasOwnProperty(u)&&(r.push(w[u].unit),
""===m||""===k)&&(m=w[u].value,k=w[u].unit);break}f.length&&(n=f.data("unit_value"));if("range"===b.attr("type"))r=d.val(),g.val(r),f.data("last_value",r),g.val(r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");r=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
r||_.isUndefined(h)||""===h?(d.val(r),f.data("last_value",r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name))):(d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",k),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=n.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),l.min=u,l.max=f,l.step=p,l.value=m,n.data("last_value",m),g.val(m));else if(""===r)if(n=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof n)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",k),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=n.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),l.min=u,l.max=f,l.step=p,l.value=m,n.data("last_value",m),g.val(m),c.addClass("tdc-css-inherited");else for(w=0;w<p.params.length;w++){if(q===p.params[w].param_name){r=[];g=[];w=p.params[w].tdc_values;for(u in w)w.hasOwnProperty(u)&&r.push(w[u].unit);for(w=0;w<r.length&&!(g=n.split(r[w]),1<g.length);w++);g.length&&(m=g[0],k=r[w],d.data("range_value",m),d.data("range_unit",k),n=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=n.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+
p),n.prop("checked",!0),l.min=u,l.max=f,l.step=p,l.value=m,n.data("last_value",m),c.find('input[type="text"]').val(m));d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(r),f.data("last_value",r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;
q=f.data("last_value");p=f.data("unit");u=d.data("min_"+p);f=d.data("max_"+p);p=d.data("step_"+p);l.min=u;l.max=f;l.step=p;""===q?(g.val(h),d.val(h),r=h):(g.val(q),d.val(q),r=q);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}n="";c=jQuery(l).parent().find('input[type="radio"]:checked');c.length&&(n=jQuery(c[0]).data("unit_value"));"focusin"===a.type?l.oldValue=l.value+n:(c=jQuery(l),
...
getCurrentStyleSettings:function(a,c){_.isUndefined(c)&&(c=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(c),a={error:k},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));var b=c.get("tag");c=c.get("attrs");c=_.clone(c);if(!_.isUndefined(c)){var e={};a={};for(var d in c)0===d.indexOf("tds_")&&(e[d]=c[d]);d=window.tdcAdminSettings.mappedShortcodes[b].params;for(b=0;b<d.length;b++){var f=!1,g=d[b];if(0===g.param_name.indexOf("tds_")){for(var l in e)if(g.param_name===l){a[l]=e[l];
f=!0;break}f||(a[g.param_name]="")}}for(l in e)switch(e=l.split("-"),e.length){case 2:if(!_.has(a,l)){d=e[0];e=!1;for(var n in a)if(d===a[n]&&1===n.split("-").length){e=!0;break}if(!e){var h;for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){var m=h;break}_.has(a,m)&&""===a[m]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0)}e||delete c[l]}break;case 3:d=e[0];b=e[2];for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],
d)){m=h;break}e=!1;for(n in a)if(d===a[n]&&n===m+"-"+b){e=!0;break}e||_.has(a,m+"-"+b)&&""===a[m+"-"+b]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0);e||delete c[l]}return c}},getCurrentListAtts:function(a,c,b){_.isUndefined(c)&&(a=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(a),a={error:k},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));a=c.get("tag");c=c.get("attrs");var e=_.clone(c);if(!_.isUndefined(e)){var d={};c={};for(var f in e)0===f.indexOf("tds_")&&(d[f]=
e[f]);f=window.tdcAdminSettings.mappedShortcodes[a].params;for(var g=0;g<f.length;g++){var l=!1,n=f[g];if(0===n.param_name.indexOf("tds_")){for(var h in d)if(n.param_name===h){c[h]=d[h];l=!0;break}l||(c[n.param_name]="")}}for(h in d)switch(d=h.split("-"),d.length){case 2:if(!_.has(c,h)){f=d[0];d=!1;for(var m in c)if(f===c[m]&&1===m.split("-").length){d=!0;break}if(!d){var q;for(q in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[q],f)){var p=q;break}_.has(c,p)&&
""===c[p]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0)}d||delete e[h]}break;case 3:f=d[0];l=d[2];for(q in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[q],f)){p=q;break}d=!1;for(m in c)if(f===c[m]&&m===p+"-"+l){d=!0;break}d||_.has(c,p+"-"+l)&&""===c[p+"-"+l]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0);d||delete e[h]}var x=[],r;for(r in window.tdcAdminSettings.listStyles[b])if(r===a){for(g=0;g<window.tdcAdminSettings.listStyles[b][r].length;g++)h=
window.tdcAdminSettings.listStyles[b][r][g],_.isArray(h)?_.map(h,function(a){_.isUndefined(e[a])||(_.isUndefined(x[g])&&(x[g]=[]),x[g].push(e[a]))}):_.isUndefined(e[h])||(_.isArray(e[h])&&e[h].length?x[g]=e[h][0]:x[g]=e[h]);break}return x}},showHideTdcCssEditor:function(a){a=jQuery("#tdc-editor-css");var c=jQuery(this).closest(".tdc-property-wrap"),b=c.find("textarea:first");a.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=b;c.next(".tdc-property-editor_css-title").length?(c.next(".tdc-property-editor_css-title").toggle(),
a.toggle()):(c.after(a),c.after('<div class="tdc-property-editor_expand tdc-property-editor_css-title"><span></span><div class="tdc-editor-toggle tdc-css-ace-editor-expand-collapse"></div></div>'),a.show(),tdcSidebar.editorCss.getSession().setValue(b.val()))},toggleEnableParamsFromText:function(a){var c=a.closest(".tdc-property-wrap"),b=c.data("enable-params");c=c.data("enable-params-reverse");b=jQuery('.tdc-property-wrap[data-enabled-by="'+b+'"]');b.length&&(""!==a.val()?"undefined"!==typeof c&&
1===c?b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):"undefined"!==typeof c&&1===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"))},toggleEnableParamsFromSelect:function(a){var c=a.val();a=a.closest(".tdc-property-wrap");var b=a.data("enable-params"),e=a.data("enable-params-reverse"),d=jQuery('.tdc-property-wrap[data-enabled-by^="'+b+'"]');d.length&&d.each(function(a,
b){a=jQuery(b);b=a.data("enabled-by");-1!==b.indexOf("--")?b.substring(b.indexOf("--")+2)===c?"undefined"!==typeof e&&1===e?a.hasClass("tdc-disabled")||a.addClass("tdc-disabled"):a.hasClass("tdc-disabled")&&a.removeClass("tdc-disabled"):"undefined"!==typeof e&&1===e?a.hasClass("tdc-disabled")&&a.removeClass("tdc-disabled"):a.hasClass("tdc-disabled")||a.addClass("tdc-disabled"):""!==c?"undefined"!==typeof e&&1===e?d.hasClass("tdc-disabled")||d.addClass("tdc-disabled"):d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):
"undefined"!==typeof e&&1===e?d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):d.hasClass("tdc-disabled")||d.addClass("tdc-disabled")})},toggleDisableParamsFromSelect:function(a){var c=a.val();a=a.closest(".tdc-property-wrap").data("disable-params");a=jQuery('.tdc-property-wrap[data-disabled-by^="'+a+'"]');a.length&&a.each(function(a,e){a=jQuery(e);e=a.data("disabled-by");-1!==e.indexOf("--")&&(e.substring(e.indexOf("--")+2)===c?a.hasClass("tdc-disabled")||a.addClass("tdc-disabled"):a.hasClass("tdc-disabled")&&
a.removeClass("tdc-disabled"))})},toggleEnableParamsFromCheckbox:function(a){var c=a.closest(".tdc-property-wrap"),b=c.data("enable-params");c=c.data("enable-params-reverse");b=jQuery('.tdc-property-wrap[data-enabled-by="'+b+'"]');b.length&&(a.is(":checked")?"undefined"!==typeof c&&1===c?b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):"undefined"!==typeof c&&1===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||
b.addClass("tdc-disabled"))},showHideTdcPalette:function(a){a=jQuery("#tdc-palette");var c=jQuery(this).closest(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.next("#tdc-palette").length?(a.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),c.after(a),a.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var a=jQuery("#tdc-palette"),c=a.prev(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.length&&(c=c.find("input").val(),a=a.find("input.wp-color-picker"),
a.tdPaletteColorPicker("open_palette",c),a.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var a=jQuery("#tdc-palette"),c=a.prev(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.length&&(c=c.find("input").val(),a.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",c))},tdcIconWrapHandler:function(a){var c=jQuery(this),b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());var e=c.closest(".tdc-property-wrap");a=b.find(".tdc-icon-selector-filter");
var d=b.find(".tdc-icon-selector-lib"),f=b.find(".tdc-icon-selector-content");d.val("");a.val("");f.children().each(function(){jQuery(this).show()});b.data("model_id",c.data("model_id"));b.data("param_name",c.data("param_name"));b.show();e.after(b);c=b.data("param_name");b=tdcIFrameData.getModel(b.data("model_id")).get("attrs");var g="";_.has(b,c)&&(g=b[c].trim());a.focus();f.find("span").each(function(){var a=jQuery(this),b=a.data("font_class");if(g===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=
...
window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(c);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(a){if(-1!==a.indexOf("[caption")){var b=/\[caption(.*)\](.*)\[\/caption\]/g.exec(a);3===b.length&&(a=b[2])}var d=jQuery("img",a).attr("src"),f=b="",g="";"undefined"===typeof d?
(a=jQuery(a),d=a.attr("src"),b=a.attr("class"),f=a.attr("height"),g=a.attr("width")):(a=jQuery("img",a),b=a.attr("class"),f=a.attr("height"),g=a.attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:b,action:"tdc_ajax_get_image_id"}}).done(function(a,b,e){"success"===b&&(_.isObject(a)&&
_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),c.attr("style","background-image: url( '"+d+"') "),c.data("image_link",d),c.data("image_id",a.image_id),c.data("image_height",f),c.data("image_width",g),c.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),b="",e=c.data("model_id"),e=tdcIFrameData.getModel(e),c.hasClass("tdc-no-image-selected")||(b=a.image_id.toString()),
a=e.get("attrs"),a.media_size_image_height=f,a.media_size_image_width=g,e.set("attrs",a),tdcSidebarController.onUpdate(e,c.data("param_name"),"",b)))}).fail(function(a,b,c){})};return!1},tdcImageRemoveHandler:function(a){var c=jQuery(a.currentTarget);a=c.closest(".tdc-property-wrap").find(".tdc-image-wrap");c.addClass("tdc-hidden-button");a.addClass("tdc-no-image-selected");jQuery.removeData(a,"image_link");a.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'");
c=a.data("model_id");c=tdcIFrameData.getModel(c);tdcSidebarController.onUpdate(c,a.data("param_name"),"","")},tdcInheritSelectHandler:function(a){a=jQuery(a.currentTarget);var c=a.closest(".tdc-property-wrap"),b=c.find("[data-responsive]"),e=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),"all");c.hasClass("tdc-property-dropdown-responsive")&&(c.hasClass("tdc-visual-selector")?(b=c.find("[data-responsive]:checked:first"),b.length&&b.prop("checked",!1),"undefined"===typeof e?(c.removeClass("tdc-css-inherited"),
b=c.find("[data-responsive]:first")):(c.addClass("tdc-css-inherited"),b=c.find('[data-responsive][value="'+e+'"]')),b.length&&b.prop("checked",!0)):"undefined"===typeof e?(c.removeClass("tdc-css-inherited"),b.find("option:selected").removeAttr("selected").find("option:first").attr("selected","selected")):(c.addClass("tdc-css-inherited"),b.val(e)),c=tdcSidebarPanel.deleteResponsiveValue(b.attr("name"),tdcSidebar.currentViewportSettings.name),e=tdcIFrameData.getModel(b.data("model_id")),b=b.data("param_name"),
tdcSidebarController.onUpdate(e,b,"",c));a.hide()},tdcInheritCheckboxHandler:function(a){a=jQuery(a.currentTarget);var c=a.closest(".tdc-property-wrap"),b=c.find("[data-responsive]"),e=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),"all");c.hasClass("tdc-property-checkbox-responsive")&&("undefined"===typeof e?(c.removeClass("tdc-css-inherited"),b.removeAttr("checked")):(""===e?b.removeAttr("checked"):b.attr("checked","checked"),c.addClass("tdc-css-inherited")),c=tdcSidebarPanel.deleteResponsiveValue(b.attr("name"),
tdcSidebar.currentViewportSettings.name),e=tdcIFrameData.getModel(b.data("model_id")),b=b.data("param_name"),tdcSidebarController.onUpdate(e,b,"",c));a.hide()},toggleEnableListMenuDepthParam:function(a){a=a.val();var c=jQuery(".tdc-list-menu-depth");""===a||"accordion"===a?c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):c.hasClass("tdc-disabled")||c.addClass("tdc-disabled")},toggleEnableGalleryACFfieldParam:function(a){var c=a.val();a=a.closest(".tdc-tab-content").find(".tdc-property-acf_field");
"acf_field"===c?a.hasClass("tdc-disabled")&&a.removeClass("tdc-disabled"):a.hasClass("tdc-disabled")||a.addClass("tdc-disabled")},toggleEnableTDSMenuLoginDrodownOnlyParams:function(a){var c=jQuery(".tdc-ml-do-show"),b=jQuery(".tdc-ml-do-hide"),e=jQuery('.tdc-ml-disable-dropdown input[type="checkbox"]');a.is(":checked")?(c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"),b.hasClass("tdc-disabled")||b.addClass("tdc-disabled")):e.is(":checked")?(c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"),
b.hasClass("tdc-disabled")||b.addClass("tdc-disabled")):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled")},toggleEnableFSLinkPostParams:function(a){var c=a.closest(".tdc-property-wrap"),b=jQuery(".tdc-property-make_child");a.is(":checked")?c.hasClass("tdc-disabled")?b.addClass("tdc-disabled"):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled")},toggleEnableBlockSortParams:function(a){a=a.find("option:selected").val();var c=jQuery(".tdc-block-sort-popular-by-day");
c.length&&("popular1"===a||"popular2"===a||"popular3"===a||"popular7"===a?c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"))},bindPanelToModel:function(a,c){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==a.cid||!_.isUndefined(c)&&(_.isUndefined(c)||!0===c)){c=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=
a;for(var b=[],e=0;e<c.params.length;e++){var d=tdcSidebarPanel._defaultGroupName;_.isEmpty(c.params[e].group)||(d=c.params[e].group);b.push(d)}b=_.uniq(b);var f=d="",g=tdcSidebar.getCurrentTabId(),l,n;d+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var h=n=l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);var m=tdcUtil.makeSafeForCSS(f);0===e?(l='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',
n='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(g)||g!=="td-tab-"+m?h+='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>':(l=n,h+='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>')}d=d+(l+h)+"</div>";h=n=l=e="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":e=
"selected";break;case "phone":h="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "landscape":l="selected";break;case "portrait":n="selected";break;case "phone":h="selected"}d+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';tdcState.isMobileComposer()?d=d+('<div class="tdc-responsive-all tdc-responsive-tablet-landscape '+e+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div><div class="tdc-responsive-phone ')+
...
d+='<div class="tdc-responsive-phone '+h+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>');d+="</div>";d+="</div>";d+='<div class="tdc-search">';d+='<i class="td-icon-search"></i>';d+='<input type="text" placeholder="Search settings..." />';d+="</div></div>";d+='<div class="tdc-sidebar-sticky-a"></div>';d+='<div class="tdc-sidebar-sticky-b"></div>';d+='<div class="tdc-tab-content-wrap">';h=n=l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);m=tdcUtil.makeSafeForCSS(f);
f="tdc-tab-no-design";var k=a.get("tag");"css"===m&&(f="tdc-tab-design");0===e?(l='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+m+'">',n='<div class="tdc-tab-content '+f+'" id="td-tab-'+m+'">',m=window.tdcAdminSettings.mappedShortcodes[k].tdc_start_values,a.unset("presetValues"),_.isUndefined(m)||(m=JSON.parse(window.atob(m)),_.isArray(m)&&1<m.length&&a.set("presetValues",m)),a.has("presetValues")&&(m=a.get("presetValues"),h+=tdcSidebarPanel._addPresetValuesSelector(m,a))):
_.isUndefined(g)||g!=="td-tab-"+m?h+='<div class="tdc-tab-content '+f+'" id="td-tab-'+m+'">':(l=n,h+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+m+'">');h+=tdcSidebarPanel._bindGroupAndGetHtml(b[e],c,a);m=' data-model_id="'+a.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&(h+='<div class="tdc-sidebar-row-buttons">',h+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+m+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',h+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+
m+' title="Get the current styles\' settings">CONSOLE: style presets</div>',h+="</div>");h+="</div>"}d=d+(l+h)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(d);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),
jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),b=a.find("[data-responsive]"),c=b.attr("name"),d=b.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[c]=JSON.parse(e)}catch(z){d={},a.hasClass("tdc-property-textfield-responsive")?""!==b.val()&&(d.all=b.val()):a.hasClass("tdc-property-dropdown-responsive")?a.hasClass("tdc-visual-selector")?(b=a.find("[data-responsive]:checked:first"),b.length?d.all=b.val():(b=a.find("[data-responsive]:first"),
b.length&&(d.all=b.val()))):b.find("option:first").val()!==b.val()&&(d.all=b.val()):a.hasClass("tdc-property-checkbox-responsive")?b.is(":checked")&&(d.all=b.val()):a.hasClass("tdc-property-range-responsive")?d.all=b.data("value"):a.hasClass("tdc-property-range_multiple-responsive")&&(d.all=b.data("range_value")+b.data("range_unit")),window.tdcResponsiveValues[c]=d}tdcSidebarPanel.setViewportCurrentResponsiveValue(b)}))});tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-tab-content-wrap").find('select[name$="font_family"]').change(function(a){a=
jQuery(this).val();""===window.tdcAdminSettings.tdcSavings&&(window.tdcAdminSettings.tdcSavings={});"undefined"===typeof window.tdcAdminSettings.tdcSavings.recentFonts&&(window.tdcAdminSettings.tdcSavings.recentFonts=[]);var b=window.tdcAdminSettings.tdcSavings.recentFonts.indexOf(a);-1!==b&&window.tdcAdminSettings.tdcSavings.recentFonts.splice(b,1);window.tdcAdminSettings.tdcSavings.recentFonts.push(a);20<=window.tdcAdminSettings.tdcSavings.recentFonts.length&&window.tdcAdminSettings.tdcSavings.recentFonts.splice(0,
1);tdcUtil.updateTdcSavings()})});jQuery(".tdc-breadcrumbs").show();tdcSidebarPanel.$_paramSwitchWrap.css("display","flex");tdcSidebarPanel.$_paramInfoSwitch.hasClass("tdc-param-switch-active")&&jQuery("#tdc-sidebar").addClass("tdc-param-info-active");0<tdcSidebarPanel.$_paramNameSwitch.length&&tdcSidebarPanel.$_paramNameSwitch.hasClass("tdc-param-switch-active")&&jQuery(".tdc-param-name").addClass("tdc-param-name-active");tdcSidebarPanel._hook.doAction("panel_rendered");tdcSidebarPanel._hook.doAction("panel_css");
(function(){if("vc_row"===a.get("tag")){var b=jQuery("body .tdc-row-col-dropdown select"),c=jQuery("body .tdc-row-stretch-dropdown select"),d=a.get("childCollection");if(!_.isUndefined(d)){d=tdcIFrameData.getChildCollectionWidths(d);_.isUndefined(d)&&(d="11");b.length?b.val(d):(b=jQuery("body .tdc-row-col-dropdown input[value='"+d+"']"),b.length&&b.attr("checked","checked"));b=a.get("attrs");if(_.has(b,"full_width"))var e=b.full_width;_.isUndefined(e)&&(e="");c.val(e)}}})();(function(){if("vc_row_inner"===
a.get("tag")){var b=jQuery("body .tdc-innerRow-col-dropdown select"),c=a.get("childCollection");if(!_.isUndefined(c)){c=tdcIFrameData.getChildCollectionWidths(c);_.isUndefined(c)&&(c="11");var d=a.get("parentModel").get("attrs"),e="";_.has(d,"width")&&(e=d.width.replace("/",""));if(b.length)switch(b.val(c),e){case "":case "11":b.find("option[value=12_12]").addClass("tdc-block-col");b.find("option[value=23_13]").removeClass("tdc-block-col");b.find("option[value=13_23]").removeClass("tdc-block-col");
b.find("option[value=13_13_13]").removeClass("tdc-block-col");break;case "13":b.find("option[value=12_12]").addClass("tdc-block-col");b.find("option[value=23_13]").addClass("tdc-block-col");b.find("option[value=13_23]").addClass("tdc-block-col");b.find("option[value=13_13_13]").addClass("tdc-block-col");break;case "23":b.find("option[value=12_12]").removeClass("tdc-block-col"),b.find("option[value=23_13]").addClass("tdc-block-col"),b.find("option[value=13_23]").addClass("tdc-block-col"),b.find("option[value=13_13_13]").addClass("tdc-block-col")}else if(b=
jQuery('body .tdc-innerRow-col-dropdown input[value="'+c+'"]'),b.length)switch(b.attr("checked","checked"),b.next("label").show(),e){case "":case "11":b.parent().find("input[value=12_12] + label").addClass("tdc-block-col");b.parent().find("input[value=23_13] + label").removeClass("tdc-block-col");b.parent().find("input[value=13_23] + label").removeClass("tdc-block-col");b.parent().find("input[value=13_13_13] + label").removeClass("tdc-block-col");break;case "13":b.parent().find("input[value=12_12] + label").addClass("tdc-block-col");
b.parent().find("input[value=23_13] + label").addClass("tdc-block-col");b.parent().find("input[value=13_23] + label").addClass("tdc-block-col");b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":b.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),b.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})();
(function(){var b=a.get("tag");if("vc_row"===b||"vc_row_inner"===b||"vc_column"===b||"vc_column_inner"===b){b=jQuery("body .tdc-property-flex_layout");var c=a.get("childCollection");if(!_.isUndefined(c)&&b.length){c=jQuery("body .tdc-property-flex_horiz_align");var d=jQuery("body .tdc-property-flex_vert_align"),e=jQuery("body .tdc-property-flex_layout_reverse");b.find("input[value=column]").is(":checked")&&(c.addClass("tdc-flex-row-align-rev"),d.addClass("tdc-flex-row-align-rev"),e.find("input").is(":checked")&&
c.addClass("tdc-flex-row-rev-align-rev"))}}})();(function(){if("td_woo_products_live_search"===a.get("tag")){var b=jQuery("body .tdc-property-woo_search_version select").val(),c=jQuery("body .tdc-woos-dropdown"),d=jQuery("body .tdc-woos-regular");""===b?d.hide():"regular"===b&&c.hide()}})();c=jQuery(".tdc-property-wrap[data-enable-params] textarea,.tdc-property-wrap[data-enable-params] input[type=text]");c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableParamsFromText(jQuery(b))});c=jQuery(".tdc-property-wrap[data-enable-params] select");
c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableParamsFromSelect(jQuery(b))});c=jQuery(".tdc-property-wrap[data-disable-params] select");c.length&&c.each(function(a,b){tdcSidebarPanel.toggleDisableParamsFromSelect(jQuery(b))});c=jQuery(".tdc-property-wrap[data-enable-params] input[type=checkbox]");c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableParamsFromCheckbox(jQuery(b))});c=jQuery(".tdc-list-menu-display select");c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableListMenuDepthParam(jQuery(b))});
c=jQuery(".tdc-gallery-source select");c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableGalleryACFfieldParam(jQuery(b))});c=jQuery('.tdc-ml-dropdown-only input[type="checkbox"]');c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableTDSMenuLoginDrodownOnlyParams(jQuery(b))});c=jQuery('.tdc-fs-link-post-toggle input[type="checkbox"]');c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableFSLinkPostParams(jQuery(b))});c=jQuery(".tdc-block-sort select");c.length&&c.each(function(a,
...
'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-colorpicker-wrap" title="'+
...
b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,c)+'"/>');b=b+'</div><span class="tdc-param-name">'+
...
d=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(d=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(f=!0);var g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var l="";_.has(a,"toggle_disable_params")&&""!==a.toggle_disable_params&&(l='data-disable-params="'+a.toggle_disable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');
var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');var m="";_.has(a,"toggle_disabled_by")&&""!==a.toggle_disabled_by&&(m='data-disabled-by="'+a.toggle_disabled_by+'"');var k="",p="",x=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&x.length<=parseInt(a.tdc_min_options))return k;for(var r=0;r<x.length;r++){var w=!1,u="",z="",B="",C="",t="",v=x[r],y=String(tdcSidebarPanel._getParameterCurrentValue(a,c)),A=String(a.value[x[r]]);_.has(a,
"options_to_disable")&&""!==a.options_to_disable&&(z=a.options_to_disable);_.has(a,"options_to_hide")&&""!==a.options_to_hide&&(B=a.options_to_hide);_.isObject(a.value[x[r]])&&(w=!0,A=_.values(a.value[x[r]])[0],v=_.keys(a.value[x[r]])[0]);if(d||f)0===r&&""===y&&(y=A),y===A&&(u=" checked "),z=_.uniqueId(),B=A,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(B="col_"+B),p+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,
c)+' id="'+z+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+u+' value="'+A+'">',d?(u="",w&&(u="tdc-standard-value"),p+='<label class="tdc-property-input-radio-label '+u+'" for="'+z+'" title="'+v+'"><div class="'+B+'"></div></label>'):p+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+v+'">'+A+"</label>";else{y===A&&(u=' selected="selected" ');if("__"===A&&-1!==v.search("--")||-1<z.indexOf(A)&&""!==A)C=" disabled ";-1<B.indexOf(A)&&""!==A&&(t=' style="display:none" ');
p+="<option "+u+" "+C+t+' value="'+A+'">'+v+"</option>"}}x="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':x=' title="'+a.description+'" ');k+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+n+" "+h+" "+m+">";k+='<div class="tdc-property-title"><span class="tdc-search-data"'+x+">"+a.heading+"</span>";b="";e="#";"tdb_flex_block_builder"===c.get("tag")&&"cloud_tpl_module_id"===a.param_name&&(b="tdc-edit-cloud_tpl_module_id",
g='style="margin-left: 10px"',_.has(c.get("attrs"),"cloud_tpl_module_id")?""===c.get("attrs").cloud_tpl_module_id.trim()?g='style="margin-left: 10px; visibility: hidden"':"undefined"!==typeof window.tdData&&(e=tdData.adminUrl+"post.php?post_id="+c.get("attrs").cloud_tpl_module_id.trim()+"&td_action=tdc&tdbTemplateType=module"):g='style="margin-left: 10px; visibility: hidden"',k+='<a href="'+e+'" class="'+b+'" target="_blank" '+g+">Edit</a>");k+='</div><div class="tdc-property">';d||f?k+=p:(k+="<select "+
tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" class="'+b+'">',k=k+p+"</select>");k=k+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return k+"</div>"},addDropDownResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=!1,f=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(d=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(f=!0);var g="";_.has(a,
"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var l="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(l='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+'"');var h="",m="",k=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&k.length<=parseInt(a.tdc_min_options))return h;var p=' data-responsive="" ',x=String(tdcSidebarPanel._getParameterCurrentValue(a,
c));try{var r=JSON.parse(window.atob(x));p=' data-responsive="'+x+'" ';"undefined"!==typeof r[tdcSidebar.currentViewportSettings.name]&&(x=r[tdcSidebar.currentViewportSettings.name])}catch(v){}for(r=0;r<k.length;r++){var w=!1,u="",z="",B=k[r],C=String(a.value[k[r]]);_.isObject(a.value[k[r]])&&(w=!0,C=_.values(a.value[k[r]])[0],B=_.keys(a.value[k[r]])[0]);if(d||f){0===r&&""===x&&(x=C);x===C&&(u=" checked ");z=_.uniqueId();var t=C;"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==
a.param_name.indexOf("flex_")||(t="col_"+t);m+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+z+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+u+' value="'+C+'" '+p+">";d?(u="",w&&(u="tdc-standard-value"),m+='<label class="tdc-property-input-radio-label '+u+'" for="'+z+'" title="'+B+'"><div class="'+t+'"></div></label>'):m+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+B+'">'+C+"</label>"}else x===C&&(u=' selected="selected" '),
"__"===C.substring(0,2)&&-1!==B.search("--")&&(z=" disabled "),m+="<option "+u+" "+z+' value="'+C+'">'+B+"</option>"}k="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':k=' title="'+a.description+'" ');h+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+n+">";h+='<div class="tdc-property-title"><span class="tdc-search-data"'+k+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';
h+='<div class="tdc-property">';d||f?h+=m:(h+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+p+k+">",h=h+m+"</select>");h=h+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return h+"</div>"},addCheckBox:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+
'" ');var f="",g=tdcSidebarPanel._getParameterCurrentValue(a,c);"product_cat_type_action"===a.param_name?""!==g&&"single_selection"!==g&&(f=" checked "):""!==g&&(f=" checked ");var l="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(l='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+
a.toggle_enabled_by+'"');var m="";_.has(a,"toggle_disabled_by")&&""!==a.toggle_disabled_by&&(m='data-disabled-by="'+a.toggle_disabled_by+'"');g="";var k=tdcSidebarPanel._getParameterClasses(a);k.includes("tdc-filter-multiple")&&(g=' title="'+a.description+'" ');b='<div class="'+k+'" '+b+" "+e+" "+l+" "+n+" "+h+" "+m+'><div class="tdc-property-title"><span class="tdc-search-data"'+(d+">"+a.heading+"</span></div>");b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+
tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+f+" "+g+"/>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},addCheckBoxResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f=' data-responsive="" ',g=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var l=JSON.parse(window.atob(g));f=' data-responsive="'+g+'" ';"undefined"!==typeof l[tdcSidebar.currentViewportSettings.name]&&
(g=l[tdcSidebar.currentViewportSettings.name])}catch(m){}""!==g&&(d=" checked ");l="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':l=' title="'+a.description+'" ');g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&
(h='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+n+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+l+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
'" type="checkbox" value="yes" '+d+f+"/>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},addRange:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"range_max")&&""!==a.range_max&&(f=a.range_max);var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);
var l="";_.has(a,"range_step")&&""!==a.range_step&&(l=a.range_step);var n="";_.has(a,"value")&&""!==a.value&&(n=a.value);var h="";""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(h=tdcSidebarPanel._getParameterCurrentValue(a,c));var m="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(m='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&
""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+k+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+h+'" data-min="'+g+'" data-max="'+f+'" data-step="'+l+'" min="'+g+'" max="'+
f+'" step="'+l+'" value="'+h+'" />');b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" value="'+h+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"range_max")&&""!==
a.range_max&&(f=a.range_max);var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);var l="";_.has(a,"range_step")&&""!==a.range_step&&(l=a.range_step);var n="";_.has(a,"value")&&""!==a.value&&(n=a.value);""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&tdcSidebarPanel._getParameterCurrentValue(a,c);var h="";_.has(a,"placeholder")&&""!==a.placeholder&&(h=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var m="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&
(m='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');var x=' data-responsive="" ',r=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var w=JSON.parse(window.atob(r));x=' data-responsive="'+r+'" ';r="undefined"===typeof w[tdcSidebar.currentViewportSettings.name]?
"":w[tdcSidebar.currentViewportSettings.name]}catch(u){}b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+k+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+r+'" data-min="'+g+'" data-max="'+f+'" data-step="'+l+'" min="'+g+'" max="'+
f+'" step="'+l+'" value="'+r+'" '+x+" />");b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" '+h+' value="'+r+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeMultiple:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&
""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');var n=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),m="",k="",p=[],x="",r="",w="",u="",z="",B="",C="",t;for(t in n)n.hasOwnProperty(t)&&(p.push(n[t].unit),""===r||""===
x)&&(u=n[t].unit,r=' data-range_unit="'+u+'" ',w=n[t].value,x=' data-range_value="'+w+'" ',z=n[t].range_min,B=n[t].range_max,C=n[t].range_step);if(""!==h){for(var v=[],y=0;y<p.length&&!(v=h.split(p[y]),1<v.length);y++);v.length&&(u=p[y],r=' data-range_unit="'+u+'" ',w=v[0],x=' data-range_value="'+w+'" ')}for(t in n)n.hasOwnProperty(t)&&(h=_.uniqueId(),m+=" data-value_"+t+'="'+n[t].value+'" ',m+=" data-min_"+t+'="'+n[t].range_min+'" ',m+=" data-max_"+t+'="'+n[t].range_max+'" ',m+=" data-step_"+t+'="'+
n[t].range_step+'" ',p=n[t].value,v="",n[t].unit===u&&(p=w,z=n[t].range_min,B=n[t].range_max,C=n[t].range_step,v="checked"),k+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+t+'" data-unit_value="'+n[t].unit+'" type="radio" id="'+h+'" '+v+' data-default_value="'+n[t].value+'" data-last_value="'+p+'"/>',k+='<label for="'+h+'">'+n[t].unit+"</label>");b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+x+" "+r+" "+m+' min="'+z+'" max="'+B+'" step="'+C+'" value="'+w+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+k+'</div><input type="text" class="tdc_range_value" value="'+(w+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+
"</span>";return b+="</div>"},addRangeMultipleResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&
(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');var n=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),k="",q="",p=[],x=' data-responsive="" ',r="",w="",u="",z="",B="",C="",t="",v;for(v in n)n.hasOwnProperty(v)&&(p.push(n[v].unit),""===w||""===r)&&(z=n[v].unit,w=' data-range_unit="'+z+'" ',u=n[v].value,r=' data-range_value="'+u+'" ',B=n[v].range_min,C=n[v].range_max,t=n[v].range_step);
if(""!==h){var y=h;try{var A=JSON.parse(window.atob(h));x=' data-responsive="'+h+'" ';y="undefined"===typeof A[tdcSidebar.currentViewportSettings.name]?"":A[tdcSidebar.currentViewportSettings.name]}catch(D){}if(""!==y){h=[];for(A=0;A<p.length&&!(h=y.split(p[A]),1<h.length);A++);h.length&&(z=p[A],w=' data-range_unit="'+z+'" ',u=h[0],r=' data-range_value="'+u+'" ')}}for(v in n)n.hasOwnProperty(v)&&(p=_.uniqueId(),k+=" data-value_"+v+'="'+n[v].value+'" ',k+=" data-min_"+v+'="'+n[v].range_min+'" ',k+=
" data-max_"+v+'="'+n[v].range_max+'" ',k+=" data-step_"+v+'="'+n[v].range_step+'" ',y=n[v].value,h="",n[v].unit===z&&(y=u,B=n[v].range_min,C=n[v].range_max,t=n[v].range_step,h="checked"),q+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+v+'" data-unit_value="'+n[v].unit+'" type="radio" id="'+p+'" '+h+' data-default_value="'+n[v].value+'" data-last_value="'+y+'"/>',q+='<label for="'+p+'">'+n[v].unit+"</label>");b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+
'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+r+" "+w+" "+k+" "+x+' min="'+B+'" max="'+C+'" step="'+t+'" value="'+u+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+q+'</div><input type="text" class="tdc_range_value" value="'+
(u+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addIconSelector:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,
"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+(tdcSidebarPanel._getParamterDataAtts(a,
c)+' data-selected_icon="'+tdcSidebarPanel._getParameterCurrentValue(a,c)+'">');b=b+'</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-icon-wrap").each(function(b,d){b=jQuery(d);a.param_name===b.data("param_name")&&(d=jQuery("#tdc-icon-selector"),d.length||(d=tdcSidebar.buildIconSelector()),d=d.find('.tdc-icon-selector-content > span[data-font_class="'+
tdcSidebarPanel._getParameterCurrentValue(a,c)+'"]'),""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(b.html(d.html()),b.closest(".tdc-property").find(".tdc-icon-remove").removeClass("tdc-hidden-button")))})});return b},addUploadImage:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&
""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";
b=b+'<div class="tdc-property"><div class="tdc-image-wrap tdc-no-image-selected" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");b=b+'</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(b,d){var e=jQuery(d);
if(!e.parent().parent(".tdc-bg-upload").length&&a.param_name===e.data("param_name")){var f=tdcSidebarPanel._getParameterCurrentValue(a,c);""!==f&&jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_url","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:f,action:"tdc_ajax_get_image_url"}}).done(function(a,b,c){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?
new tdcNotice.notice(a.errors,!0,!1):(e.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),e.data("image_link",a.image_url),e.data("image_id",f),e.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,b,c){})}})});return b},addTextField:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f="";if(_.has(a,"description")&&""!==a.description)if(""!==
b)e='data-info-descr="'+a.description+'"';else{var g=jQuery("<div>"+a.description+"</div>");a.description===g.text()?d=' title="'+a.description+'" ':f='<div class="tdc-description">'+a.description+"</div>"}g="";_.has(a,"placeholder")&&""!==a.placeholder&&(g=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var l=tdcSidebarPanel._getParameterCurrentValue(a,c);if(""===l){var k=Math.floor(65536*(1+Math.random())).toString(16).substring(1);"modal_id"===a.param_name?(l="td_m_"+
k,tdcSidebarController.onUpdate(c,"modal_id","",l)):"tc_id"===a.param_name&&(l="td_tc_"+k,tdcSidebarController.onUpdate(c,"tc_id","",l))}"undefined"!==typeof l&&null!==l&&0===l.toString().indexOf("td_encval")&&(l=l.replace("td_encval",""),l=window.atob(l));k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');
var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+k+" "+h+" "+m+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span>";d="";e="#";"tdm_block_popup"===c.get("tag")&&"page_id"===a.param_name&&(d="tdc-edit-page_id",k='style="margin-left: 10px"',_.has(c.get("attrs"),"page_id")?""===c.get("attrs").page_id.trim()?k='style="margin-left: 10px; visibility: hidden"':
"undefined"!==typeof window.tdData&&(e=tdData.adminUrl+"post.php?post="+c.get("attrs").page_id.trim()+"&action=edit"):k='style="margin-left: 10px; visibility: hidden"',b+='<a href="'+e+'" class="'+d+'" target="_blank" '+k+">Edit</a>");b=b+'</div><div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" '+g+' value="'+l+'" class="'+d+'" />');b=b+f+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+=
"</div>"},addDoShortcode:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=_.uniqueId("tdc_textarea_"),f="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':f=' title="'+a.description+'" ');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+">";b+='<div class="tdc-property-title"><span'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea tdc-textarea-visible" '+
tdcSidebarPanel._getParamterDataAtts(a,c)+">"+decodeURIComponent(atob(tdcSidebarPanel._getParameterCurrentValue(a,c)))+"</textarea>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";a=jQuery("body");a.on("change","#woo_shortcode",function(a){jQuery(a.change);a=atob(a.target.value);jQuery("#"+d).val(a).trigger("focusin")});a.on("keyup focusin","#"+d,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id")),d=window.btoa(encodeURIComponent(b.val())),
e=window.btoa(encodeURIComponent(a.target.oldValue));setTimeout(function(){tdcSidebarController.onUpdate(c,b.data("param_name"),e,d)},500)});return b},addTextFieldResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var g=jQuery("<div>"+a.description+"</div>");a.description===g.text()?d=' title="'+a.description+'" ':f='<div class="tdc-description">'+
a.description+"</div>"}g="";_.has(a,"placeholder")&&""!==a.placeholder&&(g=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var l="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(l='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+
'"');var m=' data-responsive="" ',q=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var p=JSON.parse(window.atob(q));m=' data-responsive="'+q+'" ';q="undefined"===typeof p[tdcSidebar.currentViewportSettings.name]?"":p[tdcSidebar.currentViewportSettings.name]}catch(x){}b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+l+" "+k+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+
(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" value="'+q+'" '+g+m+d+"/>");b=b+f+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+="</div>"},addTextArea:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=_.uniqueId("tdc_textarea_"),f="",g="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var l=jQuery("<div>"+
a.description+"</div>");a.description===l.text()?f=' title="'+a.description+'" ':g='<div class="tdc-description">'+a.description+"</div>"}l="";_.has(a,"placeholder")&&""!==a.placeholder&&(l=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');
var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+k+" "+h+" "+m+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea tdc-textarea-visible" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+l+'">'+
tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");b=b+g+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";jQuery("body").on("keyup focusin","#"+d,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id"));if("focusin"!==a.type&&a.target.oldValue!==a.target.value){var d=b.val(),e=a.target.oldValue;tdcSidebarController.onUpdate(c,b.data("param_name"),e,d)}a.target.oldValue=a.target.value});return b},addTextAreaHtml:function(a,c){_.has(a,"description");
return'<a href="#" class="tdc-open-wpeditor" data-model_id="'+c.cid+'" data-mapped_parameter_name="'+a.param_name+'">Edit Content</a>'},addTextAreaRawHtml:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=_.uniqueId("tdc_textarea_"),f="",g="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var l=jQuery("<div>"+a.description+"</div>");a.description===l.text()?f=' title="'+a.description+'" ':
g='<div class="tdc-description">'+a.description+"</div>"}l="";_.has(a,"placeholder")&&""!==a.placeholder&&(l=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+
a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+k+" "+h+" "+m+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(a,c)+" "+l+">"+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");b=b+g+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";jQuery.ajax({timeout:1E4,
type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(a,c)}}).done(function(a,b,c){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):jQuery("#"+d).html(a.parsed_content).addClass("tdc-textarea-visible"))}).fail(function(a,
b,c){});jQuery("body").on("keyup focusin","#"+d,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id"));if("focusin"!==a.type&&a.target.oldValue!==a.target.value){var d=window.btoa(encodeURIComponent(b.val())),e=window.btoa(encodeURIComponent(a.target.oldValue));tdcSidebarController.onUpdate(c,b.data("param_name"),e,d)}a.target.oldValue=a.target.value});return b},addTextAreaRawHtmlAce:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+
'"');var d=_.uniqueId("tdc_textarea_");_.has(a,"description")&&""!==a.description&&""!==b&&(e='data-info-descr="'+a.description+'"');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+
tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b=b+'<div class="tdc-property-editor_expand"><span></span><div class="tdc-editor-toggle tdc-html-ace-editor-expand-collapse"></div></div><div class="tdc-property tdc-raw-html-ace"><textarea id="'+(d+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(a,c)+">"+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");b=b+('<div id="'+d+'_ace_html" class="tdc-raw-html-ace-editor"></div></div><span class="tdc-param-name">')+
(a.param_name+"</span>");b+="</div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(a,c)}}).done(function(a,b,c){if("success"===b)if(_.isObject(a)&&_.has(a,"errors"))new tdcNotice.notice(a.errors,
!0,!1);else{var e=jQuery("#"+d);e.html(a.parsed_content);var f=ace.edit(d+"_ace_html");f.$blockScrolling=Infinity;f.getSession().setValue(e.val());f.getSession().on("change",function(){var a=f.getSession().getValue(),b=tdcIFrameData.getModel(e.data("model_id")),c=e.data("param_name");e.val(a);a=window.btoa(encodeURIComponent(a));tdcSidebarController.onUpdate(b,c,"",a)});f.setTheme("ace/theme/textmate");f.getSession().setMode("ace/mode/html");f.setOptions({enableBasicAutocompletion:!0,enableSnippets:!0,
wrap:!0,indentedSoftWrap:!1,fontSize:11});var g=jQuery("#tdc-ace-editor"),h=jQuery(".tdc-property-textarea_raw_html_ace .tdc-raw-html-ace"),l=g.children(".content");jQuery("body").on("click",".tdc-html-ace-editor-expand-collapse",function(){jQuery(".tdc-property-textarea_raw_html_ace .tdc-property-editor_expand").addClass("disabled");g.find("header .title").text("HTML Code Editor");g.addClass("tdc-html-ace-editor-expand");l.empty();l.append(jQuery("#"+d+"_ace_html"));g.show();tdcWindowFrame.setWindowFrame(g);
f.resize();setTimeout(function(){f.focus()},100)}).on("click",".tdc-html-ace-editor-expand .close",function(){g.removeClass("tdc-html-ace-editor-expand");g.hide();h.append(jQuery("#"+d+"_ace_html"));jQuery(".tdc-property-textarea_raw_html_ace .tdc-property-editor_expand").removeClass("disabled");tdcWindowFrame.unsetWindowFrame(g);f.resize()}).on("tdcWindowFrameResize",function(){f.resize(!0)})}}).fail(function(a,b,c){});return b},addEditorCss:function(a,c){var b=_.uniqueId("tdc_textarea_"),e="";_.has(a,
"description")&&""!==a.description&&(e=' title="'+a.description+'" ');var d='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title" data-status="loading" data-clean-title="'+a.heading+'"><span class="tdc-search-data tdc-open-csseditor"'+e+">"+a.heading+" (Loading ...)</span></div>";d=d+'<div class="tdc-property"><textarea id="'+(b+'" class="tdc-textarea tdc-editor-css" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' style="display: none">'+tdcSidebarPanel._getParameterCurrentValue(a,
c)+"</textarea>");d=d+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");d+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackEditorCss)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackEditorCss);jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce);a=jQuery("#"+
b).parent().siblings(".tdc-property-title");a.length&&a.data("status","loading")},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(a,c)}}).done(function(a,c,d){"success"===c&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c=jQuery("#"+b),d=c.parent().siblings(".tdc-property-title"),c.html(a.parsed_content).addClass("tdc-textarea-visible"),d.length&&(d.data("status","ready"),
d.html('<span class="tdc-search-data tdc-open-csseditor"'+e+">"+d.data("clean-title")+" (Ready)</span>"),"undefined"!==typeof d.data("open")&&(d.removeData("open"),d.trigger("click")))))}).fail(function(a,b,c){});var f=jQuery("#tdc-ace-editor"),g=f.children(".content");jQuery("body").on("click",".tdc-css-ace-editor-expand-collapse",function(){jQuery(".tdc-property-editor_css .tdc-property-title").addClass("disabled");jQuery(".tdc-property-editor_css-title").addClass("disabled");f.find("header .title").text("CSS Code Editor");
f.addClass("tdc-css-ace-editor-expand");g.empty();g.append(tdcSidebar.$_editorCss);f.show();tdcWindowFrame.setWindowFrame(f);tdcSidebar.editorCss.resize();setTimeout(function(){tdcSidebar.editorCss.focus()},100)}).on("click",".tdc-css-ace-editor-expand .close",function(){f.removeClass("tdc-css-ace-editor-expand");f.hide();jQuery(".tdc-property-editor_css-title").after(tdcSidebar.$_editorCss);jQuery(".tdc-property-editor_css-title, .tdc-property-editor_css .tdc-property-title").removeClass("disabled");
tdcWindowFrame.unsetWindowFrame(f);tdcSidebar.editorCss.resize()}).on("tdcWindowFrameResize",function(){tdcSidebar.editorCss.resize(!0)});return d},addSeparatorHorizontal:function(a,c){return'<div class="tdc-sidebar-horizontal-separator '+tdcSidebarPanel._getParameterClasses(a)+'"></div>'},addTextSeparatorHorizontal:function(a,c){var b=c="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(b='data-enable-params="'+a.toggle_enable_params+'"');var e="";_.has(a,"toggle_enable_params_reverse")&&
!0===a.toggle_enable_params_reverse&&(e='data-enable-params-reverse="1"');var d="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(d='data-enabled-by="'+a.toggle_enabled_by+'"');return c+='<div class="tdc-sidebar-text-separator tdc-property-title '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+d+'><span class="tdc-search-data">'+a.heading+"</span></div>"},addFontHeader:function(a,c){var b=c="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(b='data-enable-params="'+
a.toggle_enable_params+'"');var e="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(e='data-enable-params-reverse="1"');var d="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(d='data-enabled-by="'+a.toggle_enabled_by+'"');return c+='<div class="tdc-sidebar-font-header '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+d+'><span class="tdc-font-ico1" title="Font size"></span><span class="tdc-font-ico2" title="Line height (Use with px or a number that will be multiplied with the current font-size)"></span><span class="tdc-font-ico3" title="Font style"></span><span class="tdc-font-ico4" title="Font weight"></span><span class="tdc-font-ico5" title="Text transform"></span><span class="tdc-font-ico6" title="Letter spacing"></span></div>'},
addFontTitle:function(a,c){var b="",e="",d="";_.has(a,"info_img")&&""!==a.info_img&&(e='data-info-img="'+a.info_img+'"',_.has(a,"description")&&""!==a.description&&(d='data-info-descr="'+a.description+'"'));var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&
(l='data-enabled-by="'+a.toggle_enabled_by+'"');return b+='<div class="tdc-sidebar-font-title '+tdcSidebarPanel._getParameterClasses(a)+'" '+e+" "+d+" "+f+" "+g+" "+l+'><span class="tdc-search-data tdc-search-notice-font">'+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</span></div>"},addFontSettings:function(a,c){var b="",e="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(e='data-enable-params="'+a.toggle_enable_params+'"');var d="";_.has(a,"toggle_enable_params_reverse")&&!0===
a.toggle_enable_params_reverse&&(d='data-enable-params-reverse="1"');var f="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(f='data-enabled-by="'+a.toggle_enabled_by+'"');b+='<div class="tdc-font-manager-wrap '+tdcSidebarPanel._getParameterClasses(a)+'" '+e+" "+d+" "+f+">";b=b+'<div class="tdc-font-manager"><div title="Clear font settings" class="tdc-sidebar-font-reset" data-model_id="'+(c.cid+'" data-param_name="'+a.param_name+'">Reset font settings</div>');b+='<div title="Save font settings" class="tdc-sidebar-font-save" data-model_id="'+
c.cid+'" data-param_name="'+a.param_name+'">Save font settings</div>';b+='<div title="Load font settings" class="tdc-sidebar-font-load" data-model_id="'+c.cid+'" data-param_name="'+a.param_name+'">Load font settings</div>';return b+"</div></div>"},addShadowHeader:function(a,c){var b=c="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(b='data-enable-params="'+a.toggle_enable_params+'"');var e="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(e='data-enable-params-reverse="1"');
