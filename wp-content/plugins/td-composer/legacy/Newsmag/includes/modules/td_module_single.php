...
class td_module_single extends td_module_single_base {
    function get_social_sharing_top() {
        ...
        $buffy .= '<div class="td-post-sharing-top td-pb-padding-side">';
            if( td_util::get_option('tds_top_like_show') == 'show' && td_util::is_amp() === false ) {
                $buffy .= '<div class="td-post-sharing-classic">';
                    $buffy .= '<iframe title="topFacebookLike" frameBorder="0" src="' . td_global::$http_or_https . '://www.facebook.com/plugins/like.php?href=' . $this->href . '&amp;layout=button_count&amp;show_faces=false&amp;width=105&amp;action=like&amp;colorscheme=light&amp;height=21" style="border:none; overflow:hidden; width:105px; height:21px; background-color:transparent;"></iframe>';
                $buffy .= '</div>';
            }
    ...
    function get_social_sharing_bottom() {
        ...
        $buffy .= '<div class="td-post-sharing-bottom td-pb-padding-side">';

            if( td_util::get_option('tds_bottom_like_show') != 'hide' && td_util::is_amp() === false ) {
                $buffy .= '<div class="td-post-sharing-classic">';
                    $buffy .= '<iframe title="bottomFacebookLike" frameBorder="0" src="' . td_global::$http_or_https . '://www.facebook.com/plugins/like.php?href=' . $this->href . '&amp;layout=button_count&amp;show_faces=false&amp;width=105&amp;action=like&amp;colorscheme=light&amp;height=21" style="border:none; overflow:hidden; width:105px; height:21px; background-color:transparent;"></iframe>';
                $buffy .= '</div>';
            }
