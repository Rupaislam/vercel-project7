...
class td_module_11 extends td_module {
    ...
    function render() {
        ...
        $title_tag = $this->get_shortcode_att('m11_title_tag');
        $excerpt_length = $this->get_shortcode_att('m11_el');
        $modified_date = $this->get_shortcode_att('show_modified_date');
        $target_blank = $this->get_shortcode_att('open_in_new_window') === 'yes' ? 'target="_blank"' : '';
        ...
        <div class="<?php echo $this->get_module_classes($additional_classes_array);?>">
            ...
            <div class="item-details">
                ...
                <div class="td-read-more">
                    <a href="<?php echo $this->href;?>" <?php echo $target_blank;?>><?php echo __td('Read more', TD_THEME_NAME);?></a>
                </div>
            </div>
