...
class td_module_mx10 extends td_module {
    ...
    function render($order_no) {
        ...
        $title_tag = $this->get_shortcode_att('mx10_title_tag');
        ...
        <div class="<?php echo $this->get_module_classes( array_merge( array("td-big-grid-post-$order_no", "td-big-grid-post", 'td-small-thumb'),  $additional_classes_array) ); ?>">
