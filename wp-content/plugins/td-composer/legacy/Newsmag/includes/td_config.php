...
// get instagram connected personal/business accounts saved data
        ...
        td_api_block::add( 'td_block_social_share',
            array(
                'map_in_td_composer' => true,
                "name" => 'Social Share',
                "base" => "td_block_social_share",
                'tdc_category' => 'Extended' ,
                'file' => TDC_PATH_LEGACY . '/includes/shortcodes/td_block_social_share.php',
                'tdc_style_params' => array(
                    'el_class'
                ),
                "params" => array_merge(
        ...
        if ( is_admin() ) {
            ...
            <a class="button button-primary" href="https://www.youtube.com/watch?v=SoGQ0d5kIBg&list=PL6CsDkMaejhoHETIWoxnRB4zefz8L8PYg" target="_blank">View tutorials</a>'
            );
	    ...
	    add_action('after_setup_theme', function() {
		   global $td_translation_map;
			...
			$td_translation_map = array(
                ...
                'EXCLUSIVE' => __('EXCLUSIVE', 'newsmag'),
                ...
                //mobile search
                'Loading' => __('Loading', 'newsmag'),
                'Here are the results for the search:' => __('Here are the results for the search:', 'newsmag'),
                ...
                'At' => __('At', 'newsmag'),
                'on' => __('on', 'newsmag'),
                'Comments are closed.' => __('Comments are closed.', 'newsmag'),
                ...
                'Log in With Facebook' => __('Log in With Facebook', 'newsmag'),
                ...
                'CAPTCHA verification failed!' => __('CAPTCHA verification failed!', 'newsmag'),
                'CAPTCHA user score failed. Please contact us!' => __('CAPTCHA user score failed. Please contact us!', 'newsmag'),
                'Someone has requested a password reset for the following account:' => __('Someone has requested a password reset for the following account:', 'newsmag'),
                'Username: %s' => __('Username: %s', 'newsmag'),
                'If this was a mistake, just ignore this email and nothing will happen.' => __('If this was a mistake, just ignore this email and nothing will happen.', 'newsmag'),
                'To reset your password, visit the following address:' => __('To reset your password, visit the following address:', 'newsmag'),
        ...
        add_action('wp_enqueue_scripts', function () {
            ...
            if ( TDC_DEPLOY_MODE == 'dev' ) {
                ...
                wp_enqueue_style( 'td-legacy-framework-subscription-style-less', TDC_URL_LEGACY . '/td_less_style.css.php?part=subscription', false, TD_COMPOSER );
                ...
                if ( defined( 'TD_SUBSCRIPTION' ) ) {
                    wp_enqueue_style('td-legacy-framework-subscription-style', TDC_URL_LEGACY . '/assets/css/td_legacy_subscription.css' );
                }
            }
     ...
     * @return array
     */
    static function get_map_filter_array ($group = 'Filter', $show_locked_only = true) {
        ...
        //display locked post filter only on specific blocks
        if( $show_locked_only ) {
