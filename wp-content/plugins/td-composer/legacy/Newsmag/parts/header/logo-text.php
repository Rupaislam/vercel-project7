...
if ($td_customLogo !== '') {
    $td_image_id = attachment_url_to_postid($td_customLogo);
    if ( $td_image_id !== 0 ) {
...
if (!empty($td_customLogoR)) {
	...
	<a class="td-main-logo" href="<?php echo esc_url(home_url( '/' )); ?>">
		<img class="td-retina-data"  data-retina="<?php echo esc_attr($td_customLogoR) ?>" src="<?php echo $td_customLogo?>" alt="<?php echo $td_logo_alt ?>"<?php echo $td_logo_title ?><?php echo $logo_image_size ?>/>
